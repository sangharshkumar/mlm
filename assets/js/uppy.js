!(function (e) {
  ...
  var define,
      ...
      function o(e, t) {
        ...
        return (
          t.forceNew || t["force new connection"] || !1 === t.multiplex || u
            ? (r("ignoring socket cache for %s", s), (o = _$manager_59(s, t)))
            : (n[a] ||
                (r("new io instance for %s", s), (n[a] = _$manager_59(s, t))),
              (o = n[a])),
          i.query && !t.query && (t.query = i.query),
          o.socket(i.path, t)
        );
      }
      (t.protocol = _$socketIoParser_68.protocol),
        (t.connect = o),
        (t.Manager = _$manager_59),
        (t.Socket = _$socket_61);
    }),
    ...
    _$buffer_8 = createModuleFactory(function (e, t) {
      (function (e) {
        ...
        function o(t, r, o) {
          ...
          var s = (function (t) {
            ...
            return void 0 !== t.length
              ? "number" != typeof t.length || D(t.length)
                ? n(0)
                : a(t)
          ...
          if (
            ...
            return e.from(t[Symbol.toPrimitive]("string"), r, o);
          throw new TypeError(
            "The first argument must be one of type string, Buffer, ArrayBuffer, Array, or Array-like Object. Received type " +
              typeof t
          );
        ...
        function a(e) {
          for (
            var t = e.length < 0 ? 0 : 0 | l(e.length), r = n(t), o = 0;
            o < t;
            o += 1
          )
            r[o] = 255 & e[o];
        ...
        function p(t, r, n, o, i) {
          ...
          if (("string" == typeof r && (r = e.from(r, o)), e.isBuffer(r)))
            return 0 === r.length ? -1 : d(t, r, n, o, i);
          if ("number" == typeof r)
            return (
              (r &= 255),
        ...
        function v(e, t, r) {
          return 0 === t && r === e.length
            ? _$base64Js_5.fromByteArray(e)
            : _$base64Js_5.fromByteArray(e.slice(t, r));
        }
        function b(e, t, r) {
        ...
        (e.TYPED_ARRAY_SUPPORT = (function () {
          ...
          (e.compare = function (t, r) {
            if (
              ...
              U(r, Uint8Array) && (r = e.from(r, r.offset, r.byteLength)),
            ...
            if (t === r) return 0;
            for (
              var n = t.length, o = r.length, i = 0, s = Math.min(n, o);
              i < s;
              ++i
            )
              if (t[i] !== r[i]) {
        ...
        function E(e, t, r) {
          ...
          for (var i = "", s = t; s < r; ++s)
            i += (n = e[s]) < 16 ? "0" + n.toString(16) : n.toString(16);
          return i;
        }
        function C(e, t, r) {
      ...
      var N = (function () {
          ...
          return (
            ...
            (e.prototype._settledAt = function (e, t, r) {
              var n = this.promise;
              n._state === C &&
                (this._remaining--, e === $ ? I(n, r) : (this._result[t] = r)),
  ...
  (__global_77 = this),
      ...
      function y(r, n) {
        return new Promise(function (o, i) {
          ...
          (l.onload = function () {
            ...
            l.open(s.method, s.url, !0),
            "include" === s.credentials
              ? (l.withCredentials = !0)
              : "omit" === s.credentials && (l.withCredentials = !1),
    ...
    "object" == typeof _$fetchUmd_77.exports
      ? factory(_$fetchUmd_77.exports)
      : "function" == typeof define && define.amd
      ? define(["exports"], factory)
      : factory((__global_77.WHATWGFetch = {})),
    (_$fetchUmd_77 = _$fetchUmd_77.exports);
  ...
  var _$Translator_199 = (function () {
        ...
        (t.interpolate = function (e, t) {
          ...
          for (var a in t)
            if ("_" !== a && _$hasProperty_218(t, a)) {
              var l = t[a];
              "string" == typeof l && (l = o.call(t[a], i, "$$$$")),
                (s = u(s, new RegExp("%\\{" + a + "\\}", "g"), l));
            }
          return s;
          function u(e, t, r) {
            var o = [];
    ...
    _$namespaceEmitter_49 = function () {
      var e = {},
        t = (e._fns = {});
      return (
        (e.emit = function (e, r, n, o, i, s, a) {
          var l = (function (e) {
            for (
              var r = t[e] ? t[e] : [],
                n = e.indexOf(":"),
                o = -1 === n ? [e] : [e.substring(0, n), e.substring(n + 1)],
                i = Object.keys(t),
                s = 0,
                a = i.length;
              s < a;
          ...
          l.length &&
            (function (e, t, r) {
              for (var n = 0, o = t.length; n < o && t[n]; n++)
        ...
        (e.off = function (e, t) {
          var r = [];
          if (e && t)
            for (var n = this._fns[e], o = 0, i = n ? n.length : 0; o < i; o++)
              n[o] !== t && r.push(n[o]);
      ...
      return (
        ...
        (function (e, r, n) {
          ...
          return (
            ...
            g(n) &&
              ((p = !!n.leading),
              (s = (d = "maxWait" in n) ? _(m(n.maxWait) || 0, r) : s),
  ...
  (WildcardMatcher.prototype.match = function (e) {
    ...
    if ("string" == typeof e || e instanceof String)
      if (this.hasWild || this.text == e) {
        for (r = (e || "").split(this.separator), t = 0; n && t < i; t++)
          "*" !== o[t] && (n = t < r.length && o[t] === r[t]);
        n = n && r;
      } else n = !1;
  ...
  (DefaultStore.VERSION = _$package_164.version),
    (_$lib_163 = function () {
  ...
  var _$generateFileID_205 = function (e) {
      return [
        "uppy",
        e.name ? encodeFilename(e.name.toLowerCase()) : "",
        e.type,
        e.meta && e.meta.relativePath
          ? encodeFilename(e.meta.relativePath.toLowerCase())
          : "",
        e.data.size,
        e.data.lastModified,
      ]
    ...
    _$supportsUploadProgress_95 = function (e) {
      ...
      return (
        (n = parseInt(n, 10)),
        (o = parseInt(o, 10)),
        n < 15 || (15 === n && o < 15063) || n > 18 || (18 === n && o >= 18218)
      );
    };
  ...
  var _$getTimeStamp_217 = function () {
      var e = new Date();
      return (
        __pad_217(e.getHours().toString()) +
        ":" +
        __pad_217(e.getMinutes().toString()) +
        ":" +
        __pad_217(e.getSeconds().toString())
      );
    },
    debugLogger = {
      debug: function () {
        ...
        e.call.apply(
          e,
          [console, "[Uppy] [" + _$getTimeStamp_217() + "]"].concat(r)
        );
      },
      warn: function () {
        ...
        return (e = console).warn.apply(
          e,
          ["[Uppy] [" + _$getTimeStamp_217() + "]"].concat(r)
        );
      },
      error: function () {
        for (var e, t = arguments.length, r = new Array(t), n = 0; n < t; n++)
  ...
  !(function () {
    ...
    function t(t, r) {
      ...
      for (
        r &&
        null != r.children &&
        (w.length || w.push(r.children), delete r.children);
        w.length;
          ...
          "boolean" == typeof o && (o = null),
            (i = "function" != typeof t) &&
              (null == o
                ...
                ? (o = String(o))
                : "string" != typeof o && (i = !1)),
            i && n ? (a[a.length - 1] += o) : a === S ? (a = [o]) : a.push(o),
            (n = i);
      var l = new e();
      return (
        (l.nodeName = t),
        (l.children = a),
        (l.attributes = null == r ? void 0 : r),
        (l.key = null == r ? void 0 : r.key),
        void 0 !== b.vnode && b.vnode(l),
        l
      );
    }
    function r(e, t) {
    ...
    function p(e, t, r, n, o, u) {
      ...
      var p = (function e(t, r, n, o, u) {
        ...
        if (
          ...
          return (
            t && void 0 !== t.splitText && t.parentNode && (!t._component || u)
        ...
        if (
          ((k = "svg" === m || ("foreignObject" !== m && k)),
          (m = String(m)),
          (!t || !i(t, m)) &&
            ((_ = m),
            ((f = k
              ? document.createElementNS("http://www.w3.org/2000/svg", _)
              : document.createElement(_)).__n = _),
            (c = f),
            t))
        ) {
        ...
        if (null == b) {
          b = c.__preactattr_ = {};
          for (var S = c.attributes, P = S.length; P--; )
            b[S[P].name] = S[P].value;
        }
        return (
          !F &&
          w &&
                      ...
                      for (l = w; l < P; l++)
                        if (
                          ...
                          "string" == typeof (f = p) || "number" == typeof f
                            ...
                            ? !h._componentConstructor && i(h, f.nodeName)
                            : g || h._componentConstructor === f.nodeName)
                        ) {
                          (_ = u),
                            (y[l] = void 0),
                            l === P - 1 && P--,
      ...
      return (
        o && p.parentNode !== o && o.appendChild(p),
        --$ || ((F = !1), u || c()),
        p
      );
    }
    ...
    function h(e, t, r) {
      ...
      if (
        (e.prototype && e.prototype.render
          ? ((n = new e(t, r)), v.call(n, t, r))
          : (((n = new v(t, r)).constructor = e), (n.render = f)),
        o)
      )
    ...
    function g(e, t, r, o, i) {
      e.__x ||
        ...
        (e.__x = !1),
        0 !== r &&
          (1 !== r && !1 === b.syncComponentUpdates && e.base
            ? n(e)
            : m(e, 1, i)),
        e.__r && e.__r(e));
    }
      ...
      if (!e.__x) {
        ...
        if (
          (P &&
            ...
            !1 === e.shouldComponentUpdate(u, _, f)
              ? (F = !0)
              : e.componentWillUpdate && e.componentWillUpdate(u, _, f),
            (e.props = u),
            (e.state = _),
            (e.context = f)),
          ...
          if ("function" == typeof O) {
            var R = s(i);
            (a = k) && a.constructor === O && R.key == a.__k
              ? g(a, R, 1, f, !1)
              : ((A = a),
                (e._component = a = h(O, R, f)),
                (a.__b = a.__b || E),
                (a.__u = e),
                g(a, R, 0, f, !1),
                m(a, 1, n, !0)),
            ...
            (l = C),
              (A = k) && (l = e._component = null),
              (C || 1 === t) &&
                (l && (l._component = null),
                (x = p(l, i, f, n || !P, C && C.parentNode, !0)));
          if (C && x !== C && a !== k) {
            var I = C.parentNode;
            I &&
              x !== I &&
              (I.replaceChild(x, C), A || ((C._component = null), d(C, !1)));
          }
        ...
        if (
          (!P || n
            ? T.unshift(e)
            : F ||
              (e.componentDidUpdate && e.componentDidUpdate(v, w, S),
    ...
    r(v.prototype, {
      setState: function (e, t) {
        var o = this.state;
        this.__s || (this.__s = r({}, o)),
          r(o, "function" == typeof e ? e(o, this.props) : e),
  ...
  var _$isDOMElement_219 = function (e) {
    ...
    _$findDOMElement_204 = function (e, t) {
      return (
        ...
        "string" == typeof e
          ? t.querySelector(e)
          : "object" == typeof e && _$isDOMElement_219(e)
          ? e
          : void 0
      );
    };
  function ___extends_92() {
    return (___extends_92 =
      Object.assign ||
      function (e) {
        for (var t = 1; t < arguments.length; t++) {
          var r = arguments[t];
  ...
  var _$Plugin_92 = (function () {
      ...
      return (
        ...
        (t.setPluginState = function (e) {
          ...
          this.uppy.setState({
            plugins: ___extends_92(
              {},
              r,
              ((t = {}), (t[this.id] = ___extends_92({}, r[this.id], {}, e)), t)
            ),
          });
        }),
        (t.setOptions = function (e) {
          (this.opts = ___extends_92({}, this.opts, {}, e)),
            this.setPluginState();
        }),
        (t.update = function (e) {
        ...
        (t.mount = function (t, r) {
            ...
            return (
              ...
              (this.rerender = function (e) {
                a.uppy.getPlugin(a.id) &&
                  ((a.el = _$preact_53.render(a.render(e), u, a.el)),
                  a.afterUpdate());
              }),
              (this._updateUI =
                ((n = this.rerender),
              ...
              this.uppy.log(
                "Installing " + l + " to a DOM element '" + t + "'"
              ),
              this.opts.replaceTargetContent && (u.innerHTML = ""),
              (this.el = _$preact_53.render(
          ...
          if (s)
            return (
              this.uppy.log("Installing " + l + " to " + s.id),
              (this.parent = s),
              (this.el = s.addTarget(r)),
              this.onMount(),
              this.el
            );
          throw (
  ...
  var nullLogger = _$loggers_94.nullLogger,
    ...
    RestrictionError = (function (e) {
      ...
      function n() {
        for (var t, r = arguments.length, n = new Array(r), o = 0; o < r; o++)
          n[o] = arguments[o];
        return (
          ((t = e.call.apply(e, [this].concat(n)) || this).isRestriction = !0),
          t
        );
      }
      return (
    ...
    Uppy = (function () {
      function e(e) {
        ...
        if (
          ((this.opts = ___extends_93({}, r, {}, e, {
            restrictions: ___extends_93(
              {},
              r.restrictions,
              {},
              e && e.restrictions
          ...
          e && e.logger && e.debug
            ...
            : e && e.debug && (this.opts.logger = __debugLogger_93),
        ...
        this.i18nInit(),
          ...
          (this.emitter = _$namespaceEmitter_49()),
      ...
      return (
        ...
        (n.setFileState = function (e, t) {
          ...
          this.setState({
            files: ___extends_93(
              ...
              this.getState().files,
              ((r = {}),
              (r[e] = ___extends_93({}, this.getState().files[e], t)),
              r)
            ),
          });
        }),
        (n.i18nInit = function () {
          (this.translator = new _$Translator_199([
            this.defaultLocale,
            this.opts.locale,
          ])),
        ...
        (n._checkRestrictions = function (e) {
          ...
          if (n && Object.keys(this.getState().files).length + 1 > n)
            throw new RestrictionError(
              "" + this.i18n("youCanOnlyUploadX", { smart_count: n })
            );
          if (
            o &&
            !o.some(function (t) {
              return t.indexOf("/") > -1
                ? !!e.type && _$mimeMatch_48(e.type, t)
                : "." === t[0] &&
            ...
            var i = o.join(", ");
            throw new RestrictionError(
              this.i18n("youCanOnlyUploadFileTypes", { types: i })
            );
          }
          if (r && null != e.data.size && e.data.size > r)
            throw new RestrictionError(
              this.i18n("exceedsSize") + " " + _$prettyBytes_225(r)
            );
        }),
        (n._showOrLogErrorAndThrow = function (e, t) {
          ...
          throw (
            (e.isRestriction
              ...
              : this.log(a + " " + l, "error"),
            o && this.info({ message: a, details: l }, "error", 5e3),
        ...
        (n.addFile = function (e) {
          ...
          !1 === n.allowNewUpload &&
            this._showOrLogErrorAndThrow(
              new RestrictionError("Cannot add new files: already uploading."),
              { file: e }
            );
          var i = _$getFileType_213(e);
          e.type = i;
          var s,
            a = this.opts.onBeforeFileAdded(e, o);
          !1 === a &&
            this._showOrLogErrorAndThrow(
          ...
          try {
            ...
            this._showOrLogErrorAndThrow(err, { file: _ });
          }
          return (
            this.setState({
              files: ___extends_93({}, o, ((t = {}), (t[c] = _), t)),
            }),
            this.emit("file-added", _),
            this.log("Added file: " + s + ", " + c + ", mime type: " + i),
            this.opts.autoProceed &&
              !this.scheduledAutoProceed &&
              (this.scheduledAutoProceed = setTimeout(function () {
                (r.scheduledAutoProceed = null),
                  r.upload().catch(function (e) {
        ...
        (n.removeFile = function (e) {
          ...
          Object.keys(a).forEach(function (t) {
            ...
            0 !== r.length
              ? (a[t] = ___extends_93({}, o[t], { fileIDs: r }))
              : l.push(t);
          }),
            this.setState(
              ___extends_93(
                { currentUploads: a, files: i },
                0 === Object.keys(i).length && { allowNewUpload: !0 }
              )
            ),
            ...
            this.emit("file-removed", s),
            this.log("File removed: " + s.id);
        }),
        ...
        (n._addListeners = function () {
          ...
          this.on("error", function (t) {
            ...
            this.on("postprocess-progress", function (t, r) {
              e.getFile(t.id)
                ? e.setFileState(t.id, {
                    progress: ___extends_93(
                      {},
                      e.getState().files[t.id].progress,
                      { postprocess: r }
                    ),
                  })
                : e.log(
        ...
        (n._createUpload = function (e) {
          ...
          var i = _$cuid_13();
          return (
            this.emit("upload", { id: i, fileIDs: e }),
            this.setState({
              allowNewUpload: !1 !== this.opts.allowMultipleUploads,
              currentUploads: ___extends_93(
                {},
                o,
                ((t = {}), (t[i] = { fileIDs: e, step: 0, result: {} }), t)
              ),
            }),
            i
          );
  ...
  function ___wrapNativeSuper_85(e) {
    ...
    return (___wrapNativeSuper_85 = function (e) {
      ...
      function n() {
        return ___construct_85(
          e,
          arguments,
          ___getPrototypeOf_85(this).constructor
        );
      }
      return (
        (n.prototype = Object.create(e.prototype, {
  ...
  function ___getPrototypeOf_85(e) {
    return (___getPrototypeOf_85 = Object.setPrototypeOf
      ? Object.getPrototypeOf
      : function (e) {
          return e.__proto__ || Object.getPrototypeOf(e);
        })(e);
  }
  (Uppy.VERSION = _$package_96.version),
    (_$lib_93 = function (e) {
      return new Uppy(e);
    }),
    (_$lib_93.Uppy = Uppy),
    (_$lib_93.Plugin = _$Plugin_92),
    (_$lib_93.debugLogger = __debugLogger_93);
  var AuthError = (function (e) {
    ...
    _$package_91 = { version: "1.4.1" },
    _class,
    _temp;
  function ___extends_87() {
    return (___extends_87 =
      Object.assign ||
      function (e) {
        for (var t = 1; t < arguments.length; t++) {
          var r = arguments[t];
      ...
      ((_temp = _class = (function () {
        ...
        return (
          (n.headers = function () {
            ...
            return Promise.resolve(
              ___extends_87({}, this.defaultHeaders, {}, e)
            );
          }),
                  ...
                  fetch(n.hostname + "/" + e, {
                    ...
                    .catch(function (t) {
                      (t = t.isAuthError
                        ? t
                        : new Error(
                            "Could not delete " + n._getUrl(e) + ". " + t
                          )),
                        i(t);
                    });
                })
          ...
          ]) && ___defineProperties_87(t.prototype, r),
          e
        );
      })()),
      (_class.VERSION = _$package_91.version),
      _temp),
    _$tokenStorage_90 = {};
  function ___extends_86() {
    return (___extends_86 =
      Object.assign ||
      function (e) {
        for (var t = 1; t < arguments.length; t++) {
          var r = arguments[t];
      ...
      return (
            ...
            e.prototype.headers
              ...
              .then(function (e) {
                t.getAuthToken().then(function (t) {
                  r(___extends_86({}, e, { "uppy-auth-token": t }));
                });
              })
              .catch(n);
          });
        ...
        (o.onReceiveResponse = function (t) {
          ...
          var r = this.uppy.getPlugin(this.pluginId),
            n = r.getPluginState().authenticated
              ? 401 !== t.status
              : t.status < 400;
    ...
    _$Filter_147 = (function (e) {
      ...
      function n(t) {
        ...
        return (
          ((r =
            e.call(this, t) ||
            this).preventEnterPress = r.preventEnterPress.bind(
            (function (e) {
              if (void 0 === e)
  ...
  var _$ItemIcon_150 = function (e) {
      if (null !== e.itemIconString)
        switch (e.itemIconString) {
          ...
          default:
            return __h_150("img", { src: e.itemIconString });
        }
    },
  ...
  var __h_152 = _$preact_53.h,
    _$Item_152 = function (e) {
      var t = e.getItemIcon(),
        ...
        n = __h_152(_$ItemIcon_150, { itemIconString: t });
      switch (e.viewType) {
        case "grid":
          return __h_152(
            _$GridLi_149,
            ___extends_152({}, e, { className: r, itemIconEl: n })
          );
        case "list":
          return __h_152(
            _$ListLi_151,
        ...
        ? __h_153(
            ...
            __h_153(
              ...
              e.folders.map(function (t) {
                return _$Item_152(
                  ___extends_153({}, getSharedProps(t, e), {
                    type: "folder",
      ...
      return __h_146(
        ...
        __h_146(
          ...
          __h_146(
            ...
            __h_146("span", { class: "uppy-ProviderBrowser-user" }, e.username),
            __h_146(
              "button",
              {
                type: "button",
        ...
        e.showFilter && __h_146(_$Filter_147, e),
        __h_146(_$ItemList_153, {
        ...
        n > 0 &&
          __h_146(_$FooterActions_148, ___extends_146({ selected: n }, e))
      );
    },
  ...
  var __h_155 = _$preact_53.h,
    ...
    _$lib_155 =
      ((___temp_155 = ___class_155 = (function () {
        function e(e, t) {
          (this.plugin = e),
            (this.provider = t.provider),
            (this.opts = ___extends_155(
              {},
              {
                viewType: "list",
                showTitles: !0,
        ...
        return (
          ...
          (t.getFolder = function (e, t) {
            ...
            return this._loaderWrapper(
              ...
              function (n) {
                ...
                (o =
                  -1 !== s
                    ? i.directories.slice(0, s + 1)
                    : i.directories.concat([{ id: e, title: t }])),
                  (r.username = r.username ? r.username : n.username),
                  r._updateFilesAndFolders(n, [], []),
                  r.plugin.setPluginState({ directories: o });
              },
              this.handleError
            );
          }),
          ...
          (t.addFile = function (e) {
            ...
            r && _$isPreviewSupported_222(r) && (t.preview = e.thumbnail),
          ...
          (t.filterQuery = function (e) {
            ...
            this.plugin.setPluginState(
              ___extends_155({}, t, { filterInput: e ? e.target.value : "" })
            );
          }),
          ...
          (t.sortByDate = function () {
            ...
            this.plugin.setPluginState(
              ___extends_155({}, e, {
                ...
                folders: i,
                sorting:
                  "dateDescending" === n ? "dateAscending" : "dateDescending",
              })
            );
          }),
            ...
            if (t.length && this.plugin.getItemData(t[0]).size) {
              ...
              this.plugin.setPluginState(
                ___extends_155({}, e, {
                  files: n,
                  sorting:
                    "sizeDescending" === r ? "sizeAscending" : "sizeDescending",
                })
              );
            }
          }),
            ...
            if (!(r in o && o[r].loading))
              return (
                ...
                this.listAllFiles(e.requestPath)
                  ...
                  .catch(function (e) {
                    delete (n = t.plugin.getPluginState()).selectedFolders[r],
          ...
          (t.toggleCheckbox = function (e, t) {
            ...
            if (this.lastCheckbox && e.shiftKey) {
              var s,
                a = i.indexOf(this.lastCheckbox),
                l = i.indexOf(t);
              return (
                (s = a < l ? i.slice(a, l + 1) : i.slice(l, a + 1)),
            ...
            this.isChecked(t)
              ...
              : this.plugin.setPluginState({ currentSelection: u.concat([t]) });
          }),
          ...
          (t.handleAuth = function () {
            var t = this,
              ...
              o =
                this.provider.authUrl() + "?state=" + r + "&uppyVersions=" + n,
              ...
              if (
                ...
                n.token
                  ? (i.close(),
                    ...
                    t.provider.setAuthToken(n.token),
                    t.preFirstRender())
                  : t.plugin.uppy.log("did not receive token from auth window");
          ...
          (t.render = function (e, t) {
            ...
            if (
              ...
              return __h_155(
                ...
                __h_155(_$Loader_154, { i18n: this.plugin.uppy.i18n })
              );
            if (!n)
              return __h_155(
                CloseWrapper,
  ...
  (ReduxStore.VERSION = _$package_166.version),
    (_$lib_165 = function (e) {
      return new ReduxStore(e);
    }),
    (_$lib_165.STATE_UPDATE = STATE_UPDATE),
    (_$lib_165.reducer = function (e, t) {
      if ((void 0 === e && (e = {}), t.type === STATE_UPDATE)) {
        var r,
          n = ___extends_165({}, e[t.id], t.payload);
  ...
  var __h_118 = _$preact_53.h,
    ...
    _$icons_111 = {
      ...
      iconRetry: function () {
        return __h_111(
          ...
          __h_111("path", { d: "M16 11a8 8 0 1 1-8-8v2a6 6 0 1 0 6 6h2z" }),
          __h_111("path", { d: "M7.9 3H10v2H7.9z" }),
          __h_111("path", {
      ...
      iconFile: function () {
        return __h_111(
          ...
          __h_111(
            ...
            __h_111("path", { d: "M15 4v3a1 1 0 0 0 1 1h3V7h-3V4h-1z" })
          )
        );
      },
      iconText: function () {
    ...
    _$getFileTypeIcon_116 = function (e) {
      ...
      var r = e.split("/")[0],
        n = e.split("/")[1];
      return "text" === r
        ? { color: "#5a5e69", icon: iconText() }
        : "audio" === r
        ? { color: "#068dbb", icon: iconAudio() }
        : "video" === r
        ? { color: "#19af67", icon: iconVideo() }
        : "application" === r && "pdf" === n
        ? { color: "#e25149", icon: iconPDF() }
        : "image" === r
        ? { color: "#f2f2f2", icon: "" }
        : t;
    },
    ...
    _$FilePreview_108 = function (e) {
      ...
      return __h_108(
        ...
        __h_108(
          "span",
          { class: "uppy-DashboardItem-previewIcon", style: { color: n } },
          o
        ),
        __h_108(
          "svg",
    ...
    _$FilePreviewAndLink_103 = function (e) {
      return __h_103(
        "div",
        {
          ...
          style: { backgroundColor: _$getFileTypeIcon_116(e.file.type).color },
        },
        ...
        __h_103(_$FilePreview_108, { file: e.file })
      );
    },
      ...
      return __h_104(
        ...
        __h_104(
          ...
          __h_104("circle", {
            ...
            "stroke-dashoffset":
              circleLength - (circleLength / 100) * e.progress,
          })
        ),
    ...
    _$FileItem_106 = _$pure_118(function (e) {
      ...
      return __h_106(
        ...
        __h_106(
          ...
          __h_106(
            _$FileProgress_105,
            ___extends_106({}, e, { file: t, error: a, isUploaded: n })
          )
        ),
        __h_106(
          "div",
    ...
    _$FileList_107 = function (e) {
      ...
      return __h_107(
        ...
        Object.keys(e.files).map(function (t) {
          return __h_107(
            _$FileItem_106,
            ___extends_107({ key: t }, n, { file: e.files[t] })
          );
        })
      );
    };
    ...
    AddFiles = (function (e) {
      ...
      function n(t) {
        ...
        return (
          ((r =
            e.call(this, t) ||
            this).triggerFileInputClick = r.triggerFileInputClick.bind(
            _assertThisInitialized(r)
          )),
          (r.handleFileInputChange = r.handleFileInputChange.bind(
            _assertThisInitialized(r)
          )),
          (r.renderPoweredByUppy = r.renderPoweredByUppy.bind(
            _assertThisInitialized(r)
          )),
          (r.renderHiddenFileInput = r.renderHiddenFileInput.bind(
            _assertThisInitialized(r)
          )),
          (r.renderDropPasteBrowseTagline = r.renderDropPasteBrowseTagline.bind(
            _assertThisInitialized(r)
          )),
          (r.renderMyDeviceAcquirer = r.renderMyDeviceAcquirer.bind(
            _assertThisInitialized(r)
          )),
          (r.renderAcquirer = r.renderAcquirer.bind(_assertThisInitialized(r))),
          r
        );
      }
      (r = e),
      ...
      var o = n.prototype;
      return (
        (o.triggerFileInputClick = function () {
        ...
        (o.renderAcquirer = function (e) {
          ...
          return __h_97(
            ...
            __h_97(
              ...
              e.icon(),
              __h_97("div", { class: "uppy-DashboardTab-name" }, e.name)
            )
          );
        }),
        (o.render = function () {
  ...
  function UploadStatus(e) {
    switch (
      (function (e, t, r, n) {
        ...
        for (
          var o = uploadStates.STATE_WAITING, i = Object.keys(n), s = 0;
          s < i.length;
          s++
        ) {
          ...
          a.preprocess &&
            o !== uploadStates.STATE_UPLOADING &&
            (o = uploadStates.STATE_PREPROCESSING),
            a.postprocess &&
              o !== uploadStates.STATE_UPLOADING &&
              o !== uploadStates.STATE_PREPROCESSING &&
              (o = uploadStates.STATE_POSTPROCESSING);
        }
        return o;
  ...
  var __h_100 = _$preact_53.h,
      ...
      function n(t) {
        ...
        ((r = e.call(this, t) || this).saveOnEnter = function (e) {
          ...
          (r.tempStoreMeta = function (e, t) {
            var n;
            r.setState({
              formState: ___extends_100(
                {},
                r.state.formState,
                ((n = {}), (n[t] = e.target.value), n)
              ),
            });
          }),
          ...
          return __h_100(
            ...
            __h_100(
              ...
              __h_100(
                ...
                __h_100(_$FilePreview_108, { file: e })
              ),
              __h_100(
                "div",
    ...
    _$preactCssTransitionGroup_52 = { exports: {} },
    __global_52,
    __factory_52;
  ...
  (__global_52 = this),
        ...
        v = (function (e) {
          function t() {
            ...
            for (var i = arguments.length, s = Array(i), a = 0; a < i; a++)
              s[a] = arguments[a];
            return (
              (n = o = y(this, e.call.apply(e, [this].concat(s)))),
              (o.flushClassNameQueue = function () {
                r(o) && d(r(o), o.classNameQueue.join(" ")),
                  (o.classNameQueue.length = 0),
                  (o.timeout = null);
              }),
              y(o, n)
            );
          ...
          return (
            ...
            (t.prototype.transition = function (e, t, n) {
              ...
              this.endListener && this.endListener(),
                ...
                n
                  ? ((l = setTimeout(this.endListener, n)),
        ...
        b = (function (r) {
          function o(n) {
            ...
            return (
              ...
              (i.refs = {}),
              (i.state = { children: (n.children || []).slice() }),
              i
            );
          }
          return (
                ...
                f.forEach(function (e) {
                  ...
                  if (h) {
                    if (r) {
                      ...
                      n ||
                        !o ||
                        p.currentlyTransitioningKeys[t] ||
                        p.keysToEnter.push(t);
                    }
    ...
    "object" == typeof _$preactCssTransitionGroup_52.exports
      ? (_$preactCssTransitionGroup_52.exports = __factory_52(_$preact_53))
      : "function" == typeof define && define.amd
      ? define(["preact"], __factory_52)
      : (__global_52.PreactCSSTransitionGroup = __factory_52(
          __global_52.preact
        )),
    (_$preactCssTransitionGroup_52 = _$preactCssTransitionGroup_52.exports);
        ...
        __h_99(
          ...
          e.inline
            ...
            : __h_99(
                ...
                __h_99("span", { "aria-hidden": "true" }, "\xd7")
              ),
          __h_99(
            "div",
            ...
            !t && e.showSelectedFiles && __h_99(_$PickerPanelTopBar_110, e),
            e.showSelectedFiles
              ? __h_99(t ? _$AddFiles_97 : _$FileList_107, e)
              : __h_99(_$AddFiles_97, e),
            __h_99(
              TransitionWrapper,
              null,
              e.showAddFilesPanel
                ? __h_99(
                    _$AddFilesPanel_98,
                    ___extends_99({ key: "AddFilesPanel" }, e)
                  )
                : null
            ),
            __h_99(
              ...
              null,
              e.fileCardFor
                ? __h_99(_$FileCard_100, ___extends_99({ key: "FileCard" }, e))
                : null
            ),
            __h_99(
              TransitionWrapper,
              ...
              e.activePickerPanel
                ? __h_99(
                    _$PickerPanelContent_109,
                    ___extends_99({ key: "PickerPanelContent" }, e)
                  )
                : null
            ),
            __h_99(
  ...
  var __h_159 = _$preact_53.h,
    _$StatusBar_159 = function (e) {
      var t,
        ...
        f = e.totalProgress;
      if (
        h === _$StatusBarStates_160.STATE_PREPROCESSING ||
        h === _$StatusBarStates_160.STATE_POSTPROCESSING
      ) {
        var g = (function (e) {
          var t = [];
          Object.keys(e).forEach(function (r) {
            var n = e[r].progress;
            n.preprocess && t.push(n.preprocess),
              n.postprocess && t.push(n.postprocess);
          });
          var r = t[0];
          return {
            mode: r.mode,
        ...
        "determinate" === (t = g.mode) && (f = 100 * g.value),
          (r = ProgressBarProcessing(g));
      } else
        h === _$StatusBarStates_160.STATE_COMPLETE
          ? (r = ProgressBarComplete(e))
          : h === _$StatusBarStates_160.STATE_UPLOADING
          ? (e.supportsUploadProgress || ((t = "indeterminate"), (f = null)),
            (r = ProgressBarUploading(e)))
          : h === _$StatusBarStates_160.STATE_ERROR &&
            ((f = void 0), (r = ProgressBarError(e)));
      var m = "number" == typeof f ? f : 100,
        y =
          (h === _$StatusBarStates_160.STATE_WAITING && e.hideUploadButton) ||
          (h === _$StatusBarStates_160.STATE_WAITING && !e.newFiles > 0) ||
          (h === _$StatusBarStates_160.STATE_COMPLETE && e.hideAfterFinish),
        v = !u && o && !s && !a && i && !c,
        b =
          !d &&
          h !== _$StatusBarStates_160.STATE_WAITING &&
          h !== _$StatusBarStates_160.STATE_COMPLETE,
        w =
          l &&
          !p &&
      ...
      return __h_159(
        ...
        __h_159(
          ...
          v
            ? __h_159(UploadBtn, ___extends_159({}, e, { uploadState: h }))
            : null,
          S ? __h_159(RetryBtn, e) : null,
          w ? __h_159(PauseResumeButton, e) : null,
          b ? __h_159(CancelBtn, e) : null
        )
      );
    },
    UploadBtn = function (e) {
      var t = _$classnames_9(
        ...
        {
          "uppy-c-btn-primary":
            e.uploadState === _$StatusBarStates_160.STATE_WAITING,
        }
      );
      return __h_159(
        "button",
      ...
      return __h_159(
        ...
        __h_159(
          ...
          __h_159(
            ...
            __h_159("circle", { fill: "#888", cx: "8", cy: "8", r: "8" }),
            __h_159("path", {
              fill: "#FFF",
              d:
      ...
      function (e) {
        ...
        return __h_159(
          ...
          __h_159(
            ...
            " \xb7 ",
            e.i18n("xTimeLeft", { time: _$prettyETA_226(e.totalETA) })
          )
        );
      },
      500,
    ...
    ProgressBarUploading = function (e) {
      ...
      return __h_159(
        ...
        e.isAllPaused ? null : __h_159(LoadingSpinner, null),
        __h_159(
          "div",
          ...
          e.isAllPaused || r || !e.showProgressDetails
            ...
            ? __h_159(ThrottledProgressDetails, e)
            : __h_159(UnknownProgressDetails, e),
          r ? __h_159(UploadNewlyAddedFiles, e) : null
        )
      );
    },
  ...
  var __Plugin_161 = _$lib_93.Plugin,
    _$lib_161 =
      ((___temp_161 = ___class_161 = (function (e) {
        ...
        function n(t, r) {
          ...
          return (
            ...
            n.i18nInit(),
            (n.render = n.render.bind(___assertThisInitialized_161(n))),
            (n.install = n.install.bind(___assertThisInitialized_161(n))),
            n
          );
        }
        (r = e),
        ...
        return (
          ...
          (o.getUploadingState = function (e, t, r) {
            ...
            for (
              var n = _$StatusBarStates_160.STATE_WAITING,
                o = Object.keys(r),
                i = 0;
              i < o.length;
              i++
              ...
              if (s.uploadStarted && !s.uploadComplete)
                return _$StatusBarStates_160.STATE_UPLOADING;
              s.preprocess &&
                n !== _$StatusBarStates_160.STATE_UPLOADING &&
                (n = _$StatusBarStates_160.STATE_PREPROCESSING),
                s.postprocess &&
                  n !== _$StatusBarStates_160.STATE_UPLOADING &&
                  n !== _$StatusBarStates_160.STATE_PREPROCESSING &&
                  (n = _$StatusBarStates_160.STATE_POSTPROCESSING);
            }
            return n;
          }),
          (o.render = function (e) {
      ...
      ___temp_161),
    _$package_139 = { version: "1.3.2" },
    ___class_138,
    ___temp_138;
  function ___extends_138() {
    return (___extends_138 =
      Object.assign ||
      function (e) {
        for (var t = 1; t < arguments.length; t++) {
          var r = arguments[t];
    ...
    _$lib_138 =
      ((___temp_138 = ___class_138 = (function (e) {
        ...
        function n(t, r) {
          var n;
          return (
            ((n = e.call(this, t, r) || this).type = "progressindicator"),
            (n.id = n.opts.id || "Informer"),
            (n.title = "Informer"),
            (n.opts = ___extends_138({}, {}, r)),
  ...
  (function () {
    ...
    void 0 !== _$exif_35.exports
      ? (_$exif_35.exports && (_$exif_35.exports = _$exif_35.exports = t),
        (_$exif_35.exports.EXIF = t))
      : (this.EXIF = t);
    var r = (t.Tags = {
        36864: "ExifVersion",
      ...
      function o(o) {
        ...
        var s = (function (t) {
          ...
          if (
            ...
            255 != r.getUint8(0) || 216 != r.getUint8(1))
          )
          ...
          var a = (function (t) {
            if ("DOMParser" in self) {
              ...
              if (
                ...
                return e && console.log("Not a valid JPEG"), !1;
              for (
                var n = 2, o = t.byteLength, i = new DOMParser();
                n < o - 4;
                ...
                if ("http" == f(r, n, 4)) {
                  ...
                  return (
                    (l =
                      ...
                      l.slice(c)),
                    y(i.parseFromString(l, "text/xml"))
                  );
                }
                n++;
              }
              ...
              r.open("GET", e, !0),
                ...
                (r.onload = function (e) {
                  ...
                  (200 != this.status && 0 !== this.status) ||
                    ((t = this.response), s.readAsArrayBuffer(t));
                }),
                r.send();
            })(r.src);
        else {
    ...
    function c(t) {
      ...
      for (var n, o = 2, i = t.byteLength; o < i; ) {
        ...
        if (((n = r.getUint8(o + 1)), e && console.log(n), 225 == n))
          return (
            e && console.log("Found 0xFFE1 marker"),
            g(r, o + 4, r.getUint16(o + 2))
          );
        o += 2 + r.getUint16(o + 2);
      }
    }
    ...
    function d(e, t, r) {
      for (var n, o, i, s, a = new DataView(e), l = {}, u = t; u < t + r; )
        28 === a.getUint8(u) &&
          2 === a.getUint8(u + 1) &&
          (s = a.getUint8(u + 2)) in p &&
          ((i = a.getInt16(u + 3)),
          (o = p[s]),
          (n = f(a, u + 5, i)),
          l.hasOwnProperty(o)
    ...
    function _(t, r, n, o, i) {
      ...
      for (l = 0; l < u; l++)
        (s = n + 12 * l + 2),
          !(a = o[t.getUint16(s, !i)]) &&
            e &&
            console.log("Unknown tag: " + t.getUint16(s, !i)),
          (c[a] = h(t, s, r, n, i));
      return c;
    }
    function h(e, t, r, n, o) {
      ...
      switch (p) {
        ...
        case 3:
          ...
          for (i = d > 2 ? _ : t + 8, s = [], l = 0; l < d; l++)
            s[l] = e.getUint16(i + 2 * l, !o);
          return s;
        case 4:
        ...
        case 5:
          if (1 == d)
            return (
              (u = e.getUint32(_, !o)),
              (c = e.getUint32(_ + 4, !o)),
              ((a = new Number(u / c)).numerator = u),
              (a.denominator = c),
              a
            );
          for (s = [], l = 0; l < d; l++)
            (u = e.getUint32(_ + 8 * l, !o)),
              (c = e.getUint32(_ + 4 + 8 * l, !o)),
              (s[l] = new Number(u / c)),
              (s[l].numerator = u),
              (s[l].denominator = c);
          return s;
        ...
        case 10:
          ...
          for (s = [], l = 0; l < d; l++)
            s[l] = e.getInt32(_ + 8 * l, !o) / e.getInt32(_ + 4 + 8 * l, !o);
          return s;
      }
    }
    function f(e, t, r) {
    ...
    function g(t, n) {
      if ("Exif" != f(t, n, 4))
        return e && console.log("Not valid EXIF data! " + f(t, n, 4)), !1;
      var l,
        u,
        c,
        p,
      ...
      if (18761 == t.getUint16(h)) l = !1;
        ...
        if (19789 != t.getUint16(h))
          return (
            e && console.log("Not valid TIFF data! (no 0x4949 or 0x4D4D)"), !1
          );
        l = !0;
      }
      if (42 != t.getUint16(h + 2, !l))
        return e && console.log("Not valid TIFF data! (no 0x002A)"), !1;
  ...
  var _$dataURItoBlob_201 = function (e, t, r) {
    ...
    _$package_169 = { version: "1.5.0" },
    ___class_168,
    ___temp_168;
  function ___extends_168() {
    return (___extends_168 =
      Object.assign ||
      function (e) {
        for (var t = 1; t < arguments.length; t++) {
          var r = arguments[t];
  ...
  var __Plugin_168 = _$lib_93.Plugin,
    _$lib_168 =
      ((___temp_168 = ___class_168 = (function (e) {
        var t, r;
        function n(t, r) {
          var n;
          return (
            ...
            (n.onFileRemoved = function (e) {
              var t = n.queue.indexOf(e);
              -1 !== t && n.queue.splice(t, 1),
                e.preview &&
                  _$isObjectURL_221(e.preview) &&
            ...
            (n.onRestored = function () {
              ...
              Object.keys(e).forEach(function (e) {
                ...
                t.isRestored &&
                  ((t.preview && !_$isObjectURL_221(t.preview)) ||
                    n.addToQueue(t));
              });
            }),
        ...
        return (
          ...
          (o.createThumbnail = function (e, t, r) {
            ...
            return Promise.all([i, this.getOrientation(e)])
              .then(function (e) {
                var o = e[0],
                  i = e[1],
          ...
          (o.getOrientation = function (e) {
            ...
            return new Promise(function (r) {
              ...
              _$exif_35.getData(e.data, function () {
                ...
                delete t.thumbnail, n.setFileMeta(e.id, { exifdata: t });
          ...
          (o.protect = function (e) {
            ...
            if (
              (r > 4096 && ((r = 4096), (n = Math.round(r / t))),
              n > 4096 && ((n = 4096), (r = Math.round(t * n))),
              e.width > r)
            ) {
              var o = document.createElement("canvas");
              (o.width = r),
                (o.height = n),
                o.getContext("2d").drawImage(e, 0, 0, r, n),
                (e = o);
            }
            return e;
          }),
          (o.resizeImage = function (e, t, r) {
            ...
            n < 1 && (n = 1);
            for (
              var o = t * Math.pow(2, n - 1), i = r * Math.pow(2, n - 1);
              n--;
              ...
              (s.width = o),
                (s.height = i),
                s.getContext("2d").drawImage(e, 0, 0, o, i),
                (e = s),
                (o = Math.round(o / 2)),
                (i = Math.round(i / 2));
            }
          ...
          (o.requestThumbnail = function (e) {
            var t = this;
            return _$isPreviewSupported_222(e.type) && !e.isRemote
              ? this.createThumbnail(
                  ...
                  .catch(function (r) {
                    t.uppy.log(
                      ...
                      t.uppy.log(r, "warning"),
                      t.uppy.emit("thumbnail:error", t.uppy.getFile(e.id), r);
                  })
              : Promise.resolve();
          }),
          (o.install = function () {
      ...
      (___class_168.VERSION = _$package_169.version),
      ___temp_168),
    ...
    _$webkitGetAsEntryApi_211 = function (e, t) {
      var r = [],
        n = [];
      return (
        _$toArray_229(e.items).forEach(function (e) {
              ...
              (function e(n) {
                return new Promise(function (o) {
                  if (n.isFile)
                    n.file(
                      function (e) {
                        (e.relativePath = _$getRelativePath_210(n)),
                          r.push(e),
                          o();
                      },
                      function (e) {
  ...
  function trapFocus(e, t, r) {
    ...
    !(function (e) {
      ...
      ? focusOnFirstNode(e, o)
      : e.shiftKey && 0 === i
      ? (function (e, t) {
          var r = o[o.length - 1];
          r && (r.focus(), e.preventDefault());
        })(e)
      : e.shiftKey || i !== o.length - 1 || focusOnFirstNode(e, o);
  }
  var _$trapFocus_119 = {
    ...
    _$ResizeObserver_57 = { exports: {} };
  (function (e) {
    !(function (e, t) {
      "object" == typeof _$ResizeObserver_57.exports
        ? (_$ResizeObserver_57.exports = t())
        : "function" == typeof define && define.amd
        ? define(t)
        : (e.ResizeObserver = t());
    })(this, function () {
    ...
    (_$ResizeObserver_57 = _$ResizeObserver_57.exports));
  ...
  (function (e) {
    ...
    _$lodashDebounce_45 = function (e, t, r) {
      ...
      return (
        ...
        f(r) &&
          ((c = !!r.leading),
          (i = (p = "maxWait" in r) ? d(g(r.maxWait) || 0, t) : i),
  ...
  var _$createSuperFocus_114 = function () {
    ...
    return _$lodashDebounce_45(function (t, r) {
      ...
      if (!o || !e) {
        ...
        if (!o || i)
          if (i) i.focus({ preventScroll: !0 }), (e = !0);
          else {
  ...
  var _$memoizeOneCjs_47 = function (e, t) {
      ...
      return function () {
        for (var s = arguments.length, a = new Array(s), l = 0; l < s; l++)
          a[l] = arguments[l];
        return i && r === this && t(a, o)
          ? n
          : ((n = e.apply(this, a)), (i = !0), (r = this), (o = a), n);
      };
    },
    _$package_121 = { version: "1.5.0" },
    ___class_112,
    ___temp_112;
  function ___extends_112() {
    return (___extends_112 =
      Object.assign ||
      function (e) {
        for (var t = 1; t < arguments.length; t++) {
          var r = arguments[t];
  ...
  var _$lib_112 =
      ((___temp_112 = ___class_112 = (function (e) {
        var t, r;
        function n(t, r) {
          var n;
          ...
          return (
            (n.opts = ___extends_112({}, o, {}, r)),
            n.i18nInit(),
            (n.openModal = n.openModal.bind(___assertThisInitialized_112(n))),
            (n.closeModal = n.closeModal.bind(___assertThisInitialized_112(n))),
            (n.requestCloseModal = n.requestCloseModal.bind(
              ___assertThisInitialized_112(n)
            )),
            (n.isModalOpen = n.isModalOpen.bind(
              ___assertThisInitialized_112(n)
            )),
            (n.addTarget = n.addTarget.bind(___assertThisInitialized_112(n))),
            (n.removeTarget = n.removeTarget.bind(
              ___assertThisInitialized_112(n)
            )),
            (n.hideAllPanels = n.hideAllPanels.bind(
              ___assertThisInitialized_112(n)
            )),
            (n.showPanel = n.showPanel.bind(___assertThisInitialized_112(n))),
            (n.toggleFileCard = n.toggleFileCard.bind(
              ___assertThisInitialized_112(n)
            )),
            (n.toggleAddFilesPanel = n.toggleAddFilesPanel.bind(
              ___assertThisInitialized_112(n)
            )),
            (n.initEvents = n.initEvents.bind(___assertThisInitialized_112(n))),
            (n.handlePopState = n.handlePopState.bind(
              ___assertThisInitialized_112(n)
            )),
            (n.handleKeyDownInModal = n.handleKeyDownInModal.bind(
              ___assertThisInitialized_112(n)
            )),
            (n.handleKeyDownInInline = n.handleKeyDownInInline.bind(
              ___assertThisInitialized_112(n)
            )),
            ...
            (n.handlePaste = n.handlePaste.bind(
              ___assertThisInitialized_112(n)
            )),
            (n.handlePasteOnBody = n.handlePasteOnBody.bind(
              ___assertThisInitialized_112(n)
            )),
            (n.handleInputChange = n.handleInputChange.bind(
              ___assertThisInitialized_112(n)
            )),
            (n.handleDragOver = n.handleDragOver.bind(
              ___assertThisInitialized_112(n)
            )),
            (n.handleDragLeave = n.handleDragLeave.bind(
              ___assertThisInitialized_112(n)
            )),
            (n.handleDrop = n.handleDrop.bind(___assertThisInitialized_112(n))),
            (n.superFocusOnEachUpdate = n.superFocusOnEachUpdate.bind(
              ___assertThisInitialized_112(n)
            )),
            (n.recordIfFocusedOnUppyRecently = n.recordIfFocusedOnUppyRecently.bind(
              ___assertThisInitialized_112(n)
            )),
            (n.render = n.render.bind(___assertThisInitialized_112(n))),
            (n.install = n.install.bind(___assertThisInitialized_112(n))),
            (n.superFocus = _$createSuperFocus_114()),
        ...
        return (
          ...
          (o.openModal = function () {
            ...
            return (
              ...
              this.opts.animateOpenClose && this.getPluginState().isClosing
                ...
                : (this.setPluginState({ isHidden: !1 }), n()),
          ...
          (o.startListeningToResize = function () {
            ...
            (this.resizeObserver = new ResizeObserver(function (t, r) {
              var n = t[0].contentRect,
                o = n.width,
                i = n.height;
              e.uppy.log("[Dashboard] resized: " + o + " / " + i, "debug"),
                e.setPluginState({
                  containerWidth: o,
                  containerHeight: i,
          ...
          (o.handleInputChange = function (e) {
            var t = this;
            e.preventDefault(),
              _$toArray_229(e.target.files).forEach(function (e) {
                return t.addFile(e);
              });
          }),
          ...
          (o.superFocusOnEachUpdate = function () {
            var e = this.el.contains(document.activeElement),
              ...
              n = !this.opts.inline;
            r && (n || e || (t && this.ifFocusedOnUppyRecently))
              ? this.superFocus(
                  this.el,
                  this.getPluginState().activeOverlayType
                )
          ...
          (o.render = function (e) {
            var t = this.getPluginState(),
              ...
              c = Object.keys(r).filter(function (e) {
                return (
                  !r[e].progress.uploadComplete && r[e].progress.uploadStarted
                );
              }),
          ...
          (o.install = function () {
            ...
            o && this.mount(o, this),
              ...
              this.opts.disableInformer ||
                this.uppy.use(_$lib_138, {
                  id: this.id + ":Informer",
                  target: this,
                }),
              this.opts.disableThumbnailGenerator ||
                this.uppy.use(_$lib_168, {
      ...
      (___class_112.VERSION = _$package_121.version),
      ___temp_112),
  ...
  var __Plugin_122 = _$lib_93.Plugin,
    ...
    _$lib_122 =
      ((___temp_122 = ___class_122 = (function (e) {
        var t, r;
        function n(t, r) {
          var n;
          return (
            ...
            (n.isDragDropSupported = _$isDragDropSupported_220()),
            (n.removeDragOverClassTimeout = null),
            n.i18nInit(),
            (n.handleInputChange = n.handleInputChange.bind(
              ___assertThisInitialized_122(n)
            )),
            (n.handleDragOver = n.handleDragOver.bind(
              ___assertThisInitialized_122(n)
            )),
            ...
            (n.handleDrop = n.handleDrop.bind(___assertThisInitialized_122(n))),
            (n.addFile = n.addFile.bind(___assertThisInitialized_122(n))),
            (n.render = n.render.bind(___assertThisInitialized_122(n))),
            n
          );
        }
        (r = e),
        ...
        return (
          ...
          (o.handleInputChange = function (e) {
            this.uppy.log("[DragDrop] Files selected through input"),
              _$toArray_229(e.target.files).forEach(this.addFile),
              (e.target.value = null);
          }),
          (o.handleDrop = function (e, t) {
            var r = this;
      ...
      (___class_122.VERSION = _$package_123.version),
      ___temp_122),
    _$package_127 = { version: "1.4.0" },
    ___class_126,
    ___temp_126;
  ...
  var __Plugin_126 = _$lib_93.Plugin,
    ...
    _$lib_126 =
      ((___temp_126 = ___class_126 = (function (e) {
        ...
        function n(t, r) {
          ...
          return (
            ...
            n.i18nInit(),
            (n.render = n.render.bind(___assertThisInitialized_126(n))),
            (n.handleInputChange = n.handleInputChange.bind(
              ___assertThisInitialized_126(n)
            )),
            (n.handleClick = n.handleClick.bind(
              ___assertThisInitialized_126(n)
            )),
            n
          );
      ...
      (___class_126.VERSION = _$package_127.version),
      ___temp_126),
    _$package_143 = { version: "1.3.2" },
    ___class_142,
    ___temp_142;
        ...
        return (
          (o.render = function (e) {
            ...
            return __h_142(
              ...
              __h_142("div", { class: "uppy-ProgressBar-percentage" }, t)
            );
          }),
          (o.install = function () {
            var e = this.opts.target;
  ...
  var __Plugin_124 = _$lib_93.Plugin,
    ...
    _$lib_124 =
      ((___temp_124 = ___class_124 = (function (e) {
        var t, r;
        function n(t, r) {
          var n;
          return (
            ((n = e.call(this, t, r) || this).id = n.opts.id || "Dropbox"),
            __Provider_124.initPlugin(___assertThisInitialized_124(n), r),
            ...
            (n.onFirstRender = n.onFirstRender.bind(
              ___assertThisInitialized_124(n)
            )),
            (n.render = n.render.bind(___assertThisInitialized_124(n))),
            n
          );
        }
        (r = e),
        ...
        return (
          (o.install = function () {
            (this.view = new _$lib_155(this, { provider: this.provider })),
              this.setPluginState({
                authenticated: !1,
                files: [],
                folders: [],
      ...
      (___class_124.VERSION = _$package_125.version),
      ___temp_124),
    _$DriveProviderViews_135 = (function (e) {
      ...
      return (
        ...
        (n.prototype.toggleCheckbox = function (t, r) {
          t.stopPropagation(),
            t.preventDefault(),
            r.custom.isTeamDrive ||
              r.custom.isSharedDrive ||
              e.prototype.toggleCheckbox.call(this, t, r);
        }),
        n
      );
    })(_$lib_155),
    _$package_137 = { version: "1.3.3" },
    ___class_136,
    ___temp_136;
      ...
      ((___temp_136 = ___class_136 = (function (e) {
        ...
        function n(t, r) {
          ...
          return (
            ...
            __Provider_136.initPlugin(___assertThisInitialized_136(n), r),
            (n.title = n.opts.title || "Google Drive"),
            (n.icon = function () {
              return __h_136(
                "svg",
            ...
            (n.onFirstRender = n.onFirstRender.bind(
              ___assertThisInitialized_136(n)
            )),
          ...
          return (
            ...
            (n.icon = function () {
              return __h_140(
                ...
                __h_140("circle", { cx: "390.476", cy: "121.524", r: "30.23" })
              );
            }),
            ...
            (n.onFirstRender = n.onFirstRender.bind(
              ___assertThisInitialized_140(n)
            )),
  ...
  var __h_191 = _$preact_53.h,
    UrlUI = (function (e) {
      ...
      function n(t) {
        var r;
        return (
          ((r = e.call(this, t) || this).handleKeyPress = r.handleKeyPress.bind(
            ___assertThisInitialized_191(r)
          )),
          (r.handleClick = r.handleClick.bind(___assertThisInitialized_191(r))),
          r
        );
      }
      (r = e),
    ...
    _$package_194 = { version: "1.4.0" },
    ___class_192,
    ___temp_192;
  function ___extends_192() {
    return (___extends_192 =
      Object.assign ||
      function (e) {
        for (var t = 1; t < arguments.length; t++) {
          var r = arguments[t];
  ...
  var _$lib_192 =
      ((___temp_192 = ___class_192 = (function (e) {
        var t, r;
        function n(t, r) {
          var n;
          if (
          ...
          return (
            (n.getMeta = n.getMeta.bind(___assertThisInitialized_192(n))),
            (n.addFile = n.addFile.bind(___assertThisInitialized_192(n))),
            (n.handleRootDrop = n.handleRootDrop.bind(
              ___assertThisInitialized_192(n)
            )),
            (n.handleRootPaste = n.handleRootPaste.bind(
              ___assertThisInitialized_192(n)
            )),
            (n.client = new __RequestClient_192(t, {
              companionUrl: n.opts.companionUrl,
              companionHeaders: n.opts.companionHeaders || n.opts.serverHeaders,
            })),
            n
        ...
        return (
              ...
              this.checkIfCorrectURL(e)
                ? this.getMeta(e)
                    ...
                    .catch(function (e) {
                      t.uppy.log(e),
                        t.uppy.info(
                          { message: t.i18n("failedToFetch"), details: e },
                          "error",
                          4e3
                        );
                    })
                : (this.uppy.log("[URL] Incorrect URL entered: " + e),
                  void this.uppy.info(
          ...
          (o.handleRootDrop = function (e) {
            var t = this;
            _$forEachDroppedOrPastedUrl_193(
              e.dataTransfer,
              "drop",
              function (e) {
      ...
      (___class_192.VERSION = _$package_194.version),
      ___temp_192),
    mimeToExtensions = {
      "video/ogg": "ogv",
      "audio/ogg": "ogg",
      ...
      return t
        ? __h_233(
            ...
            __h_233(
              ...
              __h_233("rect", { x: "15", y: "15", width: "70", height: "70" })
            )
          )
        : __h_233(
            "button",
            ...
            __h_233(
              ...
              __h_233("circle", { cx: "50", cy: "50", r: "40" })
            )
          );
    },
  ...
  var CameraScreen = (function (e) {
        ...
        (o.render = function () {
          ...
          return __h_231(
            ...
            __h_231(
              ...
              t ? _$SnapshotButton_234(this.props) : null,
              " ",
              e ? _$RecordButton_233(this.props) : null
            )
          );
        }),
        n
    ...
    _$PermissionsScreen_232 = function (e) {
      return __h_232(
        ...
        __h_232("div", { class: "uppy-Webcam-permissonsIcon" }, e.icon()),
        __h_232(
          "h1",
          { class: "uppy-Webcam-title" },
          e.i18n("allowAccessTitle")
        ),
        __h_232("p", null, e.i18n("allowAccessDescription"))
      );
    },
    _$package_237 = { version: "1.4.0" },
    ___class_235,
    ___temp_235;
  function ___extends_235() {
    return (___extends_235 =
      Object.assign ||
      function (e) {
        for (var t = 1; t < arguments.length; t++) {
          var r = arguments[t];
  ...
  var __h_235 = _$preact_53.h,
    ...
    _$lib_235 =
      ((___temp_235 = ___class_235 = (function (e) {
        var t, r;
        function n(t, r) {
          var n;
          ...
          return (
            (n.opts = ___extends_235({}, o, {}, r)),
            n.i18nInit(),
            (n.install = n.install.bind(___assertThisInitialized_235(n))),
            (n.setPluginState = n.setPluginState.bind(
              ___assertThisInitialized_235(n)
            )),
            (n.render = n.render.bind(___assertThisInitialized_235(n))),
            (n.start = n.start.bind(___assertThisInitialized_235(n))),
            (n.stop = n.stop.bind(___assertThisInitialized_235(n))),
            (n.takeSnapshot = n.takeSnapshot.bind(
              ___assertThisInitialized_235(n)
            )),
            (n.startRecording = n.startRecording.bind(
              ___assertThisInitialized_235(n)
            )),
            (n.stopRecording = n.stopRecording.bind(
              ___assertThisInitialized_235(n)
            )),
            (n.oneTwoThreeSmile = n.oneTwoThreeSmile.bind(
              ___assertThisInitialized_235(n)
            )),
            (n.focus = n.focus.bind(___assertThisInitialized_235(n))),
            (n.webcamActive = !1),
            n.opts.countdown && (n.opts.onBeforeSnapshot = n.oneTwoThreeSmile),
            n
          );
        }
        (r = e),
        ...
        return (
          ...
          (o.startRecording = function () {
            ...
            r &&
              MediaRecorder.isTypeSupported(r) &&
              _$getFileTypeExtension_214(r) &&
              (t.mimeType = r),
              (this.recorder = new MediaRecorder(this.stream, t)),
                ...
                o = setInterval(function () {
                  if (!e.webcamActive)
                    return (
                      ...
                      r(new Error("Webcam is not active"))
                    );
                  n > 0
            ...
            this.captureInProgress ||
              ...
              this.opts
                ...
                .catch(function (t) {
                  ...
                  return (
                    e.uppy.info(r, "error", 5e3),
                    Promise.reject(new Error("onBeforeSnapshot: " + r))
                  );
                })
                .then(function () {
                  return e.getImage();
          ...
          (o.getImage = function () {
            ...
            return (
              ...
              _$canvasToBlob_200(i, "image/jpeg").then(function (t) {
                return {
                  source: e.id,
                  name: r,
                  data: new Blob([t], { type: "image/jpeg" }),
                  type: "image/jpeg",
                };
              })
            );
      ...
      (___class_235.VERSION = _$package_237.version),
      ___temp_235),
    ...
    _$querystringify_55 = {},
    undef,
    __has_55 = Object.prototype.hasOwnProperty;
  function decode(e) {
    try {
  ...
  (function (e) {
    ...
    function a(r) {
      ...
      else if ("string" === a) for (n in ((i = new u(r, {})), s)) delete i[n];
      else if ("object" === a) {
    ...
    function u(e, t, r) {
      ...
      for (
        "object" !== f && "string" !== f && ((r = t), (t = null)),
          r && "function" != typeof r && (r = _$querystringify_55.parse),
          t = a(t),
          n = !(s = l(e || "")).protocol && !s.slashes,
          g.slashes = s.slashes || (n && t.slashes),
          g.protocol = s.protocol || t.protocol || "",
          e = s.rest,
          s.slashes || (h[3] = [/(.*)/, "pathname"]);
        m < h.length;
        m++
      )
        "function" != typeof (p = h[m])
          ? ((c = p[0]),
            (_ = p[1]),
            c != c
              ? (g[_] = e)
              ...
              ? ~(d = e.indexOf(c)) &&
                ("number" == typeof p[2]
                  ? ((g[_] = e.slice(0, d)), (e = e.slice(d + p[2])))
                  : ((g[_] = e.slice(d)), (e = e.slice(0, d))))
              : (d = c.exec(e)) && ((g[_] = d[1]), (e = e.slice(0, d.index))),
            (g[_] = g[_] || (n && p[3] && t[_]) || ""),
            p[4] && (g[_] = g[_].toLowerCase()))
          : (e = p(e));
      r && (g.query = r(g.query)),
        n &&
          t.slashes &&
        ...
        _$requiresPort_56(g.port, g.protocol) ||
      ...
      set: function (e, t, r) {
        ...
        switch (e) {
          case "query":
            "string" == typeof t &&
              t.length &&
              (t = (r || _$querystringify_55.parse)(t)),
              (n[e] = t);
            break;
          case "port":
            (n[e] = t),
              _$requiresPort_56(t, n.protocol)
  ...
  var _$RateLimitedQueue_198 = (function () {
    ...
    _$emitSocketProgress_202 = _$lodashThrottle_46(
      function (e, t, r) {
        var n = t.progress,
          o = t.bytesUploaded,
          i = t.bytesTotal;
    ...
    _$package_239 = { version: "1.4.0" },
    ___class_238,
    ___temp_238;
  function ___extends_238() {
    return (___extends_238 =
      Object.assign ||
      function (e) {
        for (var t = 1; t < arguments.length; t++) {
          var r = arguments[t];
  ...
  function buildResponseError(e, t) {
    return (
      ...
      t instanceof Error ||
        (t = ___extends_238(new Error("Upload error"), { data: t })),
      (t.request = e),
      t
    );
  }
  ...
  var _$lib_238 =
      ((___temp_238 = ___class_238 = (function (e) {
        var t, r;
        function n(t, r) {
          var n;
          ...
          if (
            ...
            n.opts.__queue instanceof _$RateLimitedQueue_198
              ? (n.requests = n.opts.__queue)
              : (n.requests = new _$RateLimitedQueue_198(n.opts.limit)),
        ...
        return (
          ...
          (o.getOptions = function (e) {
            ...
            return (
              ___extends_238(r.headers, this.opts.headers),
              t && ___extends_238(r.headers, t.headers),
              e.xhrUpload && ___extends_238(r.headers, e.xhrUpload.headers),
              r
            );
          }),
          (o.addMetadata = function (e, t, r) {
            (Array.isArray(r.metaFields)
              ? r.metaFields
              : Object.keys(t)
            ).forEach(function (r) {
              e.append(r, t[r]);
          ...
          (o.createBundledUpload = function (e, t) {
            ...
            return (
              this.addMetadata(n, o, t),
              e.forEach(function (e) {
                var t = r.getOptions(e),
                  o = setTypeInBlob(e);
                e.name
                  ? n.append(t.fieldName, o, e.name)
                  : n.append(t.fieldName, o);
              }),
              n
            );
          }),
          ...
          (o.upload = function (e, t, r) {
            ...
            return (
              ...
              new Promise(function (t, r) {
                ...
                var i = o.formData
                    ? n.createFormDataUpload(e, o)
                    : n.createBareUpload(e, o),
                ...
                a.upload.addEventListener("loadstart", function (e) {
                  ...
                  a.addEventListener("load", function (i) {
                    if (
                      (n.uppy.log("[XHRUpload] " + l + " finished"),
                      s.done(),
                      u.done(),
                      n.uploaderEvents[e.id] &&
                        (n.uploaderEvents[e.id].remove(),
                        (n.uploaderEvents[e.id] = null)),
                      o.validateStatus(i.target.status, a.responseText, a))
                    ) {
                      var c = o.getResponseData(a.responseText, a),
                        p = c[o.responseUrlFieldName],
                        d = { status: i.target.status, body: c, uploadURL: p };
                      return (
                        n.uppy.emit("upload-success", e, d),
                        p && n.uppy.log("Download " + e.name + " from " + p),
                        t(e)
                      );
                    }
                    var _ = o.getResponseData(a.responseText, a),
                      h = buildResponseError(
                        a,
                        o.getResponseError(a.responseText, a)
                      ),
                      f = { status: i.target.status, body: _ };
                    return n.uppy.emit("upload-error", e, h, f), r(h);
                  }),
                  a.addEventListener("error", function (t) {
                    n.uppy.log("[XHRUpload] " + l + " errored"),
                      s.done(),
                      u.done(),
                      n.uploaderEvents[e.id] &&
                        (n.uploaderEvents[e.id].remove(),
                        (n.uploaderEvents[e.id] = null));
                    var i = buildResponseError(
                      a,
                      o.getResponseError(a.responseText, a)
                    );
                    return n.uppy.emit("upload-error", e, i), r(i);
                  }),
                  a.open(o.method.toUpperCase(), o.endpoint, !0),
          ...
          (o.uploadRemote = function (e, t, r) {
            ...
            return new Promise(function (t, r) {
              ...
              (Array.isArray(o.metaFields)
                ...
                new (e.remote.providerOptions.provider
                  ? __Provider_238
                  : __RequestClient_238)(n.uppy, e.remote.providerOptions)
                  .post(
                    e.remote.url,
                    ___extends_238({}, e.remote.body, {
                      endpoint: o.endpoint,
                      size: e.data.size,
                  ...
                  .then(function (i) {
                    ...
                    (n.uploaderEvents[e.id] = new _$EventTracker_195(n.uppy)),
                      ...
                      l.on("success", function (r) {
                        ...
                        return (
                          n.uppy.emit("upload-success", e, a),
                          u.done(),
                          n.uploaderEvents[e.id] &&
                            (n.uploaderEvents[e.id].remove(),
                            (n.uploaderEvents[e.id] = null)),
                      ...
                      l.on("error", function (t) {
                        var i = t.response,
                          s = i
                            ? o.getResponseError(i.responseText, i)
                            : ___extends_238(new Error(t.error.message), {
                                cause: t.error,
                              });
                        n.uppy.emit("upload-error", e, s),
                          u.done(),
                          n.uploaderEvents[e.id] &&
                            (n.uploaderEvents[e.id].remove(),
                            (n.uploaderEvents[e.id] = null)),
          ...
          (o.uploadBundle = function (e) {
            ...
            return new Promise(function (r, n) {
              var o = t.opts.endpoint,
                ...
                a = t.createBundledUpload(
                  e,
                  ___extends_238({}, t.opts, {}, s || {})
                ),
              ...
              l.upload.addEventListener("loadstart", function (e) {
                t.uppy.log("[XHRUpload] started uploading bundle"),
                  u.progress();
              }),
                ...
                l.addEventListener("load", function (o) {
                  if (
                    (u.done(),
                    t.opts.validateStatus(o.target.status, l.responseText, l))
                  ) {
                    var i = t.opts.getResponseData(l.responseText, l),
                      s = { status: o.target.status, body: i };
                    return (
                      e.forEach(function (e) {
                  ...
                  var a =
                    t.opts.getResponseError(l.responseText, l) ||
                ...
                l.open(i.toUpperCase(), o, !0),
                (l.withCredentials = t.opts.withCredentials),
                "" !== t.opts.responseType &&
                  (l.responseType = t.opts.responseType),
      ...
      (___class_238.VERSION = _$package_239.version),
      ___temp_238),
    _$package_84 = { version: "1.3.3" },
    ___class_83,
    ___temp_83;
  ...
  var _$lib_83 =
    ((___temp_83 = ___class_83 = (function (e) {
      var t, r;
      function n(t, r) {
        var n;
        ((n = e.call(this, t, r) || this).type = "uploader"),
          (n.id = n.opts.id || "AwsS3"),
          (n.title = "AWS S3"),
          (n.defaultLocale = {
            strings: { preparingUpload: "Preparing upload..." },
          });
        var o = {
          timeout: 3e4,
          limit: 0,
          getUploadParameters: n.getUploadParameters.bind(
            ___assertThisInitialized_83(n)
          ),
        };
        return (
          (n.opts = ___extends_83({}, o, {}, r)),
          n.i18nInit(),
          (n.client = new __RequestClient_83(t, r)),
          (n.prepareUpload = n.prepareUpload.bind(
            ___assertThisInitialized_83(n)
          )),
          (n.requests = new _$RateLimitedQueue_198(n.opts.limit)),
          n
      ...
      return (
        ...
        (o.getUploadParameters = function (e) {
          ...
          return this.client
            .get("s3/params?filename=" + t + "&type=" + r)
          ...
          return Promise.all(
            e.map(function (e) {
              ...
              return r(n)
                ...
                .then(function (e) {
                  return (
                    t.uppy.emit("preprocess-progress", n, {
                      mode: "determinate",
                      message: t.i18n("preparingUpload"),
                      value: 1,
                    }),
            ...
            t.uppy.setState({ files: ___extends_83({}, o, {}, n) }),
              e.forEach(function (e) {
                var r = t.uppy.getFile(e);
        ...
        (o.install = function () {
              ...
              getResponseData: function (r, n) {
                ...
                return isXml(n)
                  ? {
                      location:
                        ((o = n.responseURL),
                        (i = getXmlValue(r, "Location")),
                        new URL_(i, o).toString()),
          ...
          this.opts.getResponseData &&
            (r.getResponseData = this.opts.getResponseData),
            this.uppy.use(_$lib_238, r);
        }),
        (o.uninstall = function () {
          var e = this.uppy.getPlugin("XHRUpload");
          this.uppy.removePlugin(e),
            this.uppy.removePreProcessor(this.prepareUpload);
        }),
        n
      );
    })(__Plugin_83)),
    (___class_83.VERSION = _$package_84.version),
    ___temp_83);
  function ___extends_80() {
    return (___extends_80 =
      Object.assign ||
      function (e) {
        for (var t = 1; t < arguments.length; t++) {
          var r = arguments[t];
  ...
  var MultipartUploader = (function () {
      function e(e, t) {
        (this.options = ___extends_80({}, defaultOptions, {}, t)),
          (this.file = e),
      ...
      return (
        (t._initChunks = function () {
          for (
            var e = [],
              t = Math.max(Math.ceil(this.file.size / 1e4), 5242880),
              r = 0;
            r < this.file.size;
            r += t
          ) {
  ...
  var _$lib_81 =
      ((___temp_81 = ___class_81 = (function (e) {
        var t, r;
        function n(t, r) {
          var n;
          ((n = e.call(this, t, r) || this).type = "uploader"),
            (n.id = n.opts.id || "AwsS3Multipart"),
            (n.title = "AWS S3 Multipart"),
            (n.client = new __RequestClient_81(t, r));
          var o = {
            timeout: 3e4,
            limit: 0,
            createMultipartUpload: n.createMultipartUpload.bind(
              ___assertThisInitialized_81(n)
            ),
            listParts: n.listParts.bind(___assertThisInitialized_81(n)),
            prepareUploadPart: n.prepareUploadPart.bind(
              ___assertThisInitialized_81(n)
            ),
            abortMultipartUpload: n.abortMultipartUpload.bind(
              ___assertThisInitialized_81(n)
            ),
            completeMultipartUpload: n.completeMultipartUpload.bind(
              ___assertThisInitialized_81(n)
            ),
          };
          return (
            (n.opts = ___extends_81({}, o, {}, r)),
            (n.upload = n.upload.bind(___assertThisInitialized_81(n))),
            (n.requests = new _$RateLimitedQueue_198(n.opts.limit)),
        ...
        return (
          ...
          (o.completeMultipartUpload = function (e, t) {
            ...
            return this.client
              .post("s3/multipart/" + s + "/complete?key=" + i, { parts: o })
              .then(__assertServerError_81);
          }),
          ...
          (o.uploadFile = function (e) {
            var t = this;
            return new Promise(function (r, n) {
              var o = new _$MultipartUploader_80(
                e.data,
                ___extends_81(
                  {
                    ...
                    completeMultipartUpload: t.opts.completeMultipartUpload.bind(
                      t,
                      e
                    ),
                    ...
                    onError: function (r) {
                      t.uppy.log(r),
                        t.uppy.emit("upload-error", e, r),
                        (r.message = "Failed because: " + r.message),
                        i.done(),
                    ...
                    onSuccess: function (n) {
                      ...
                      i.done(),
                        ...
                        n.location &&
                          t.uppy.log(
                            "Download " + o.file.name + " from " + n.location
                          ),
                        r(o);
                    },
              ...
              (t.uploaders[e.id] = o),
                (t.uploaderEvents[e.id] = new _$EventTracker_195(t.uppy));
            ...
            return (
              ...
              e.serverToken
                ...
                : new Promise(function (r, n) {
                    new (e.remote.providerOptions.provider
                      ? __Provider_81
                      : __RequestClient_81)(t.uppy, e.remote.providerOptions)
                      .post(
                        e.remote.url,
                        ___extends_81({}, e.remote.body, {
                      ...
                      .then(function (r) {
                        return (
                          t.uppy.setFileState(e.id, { serverToken: r.token }),
          ...
          (o.connectToServerSocket = function (e) {
            ...
            return new Promise(function (r, n) {
              var o = e.serverToken,
                ...
                s = new __Socket_81({ target: i + "/api/" + o, autoOpen: !1 });
              (t.uploaderSockets[e.id] = s),
                ...
                s.on("error", function (r) {
                  t.uppy.emit("upload-error", e, new Error(r.error)),
                    t.resetUploaderReferences(e.id),
                    a.done(),
                    n(new Error(r.error));
                }),
              ...
              var a = t.requests.run(function () {
                return (
                  s.open(), e.isPaused && s.send("pause", {}), function () {}
                );
              });
            });
          }),
          ...
          (o.install = function () {
            var e = this.uppy.getState().capabilities;
            this.uppy.setState({
              capabilities: ___extends_81({}, e, { resumableUploads: !0 }),
            }),
          ...
          (o.uninstall = function () {
            var e = this.uppy.getState().capabilities;
            this.uppy.setState({
              capabilities: ___extends_81({}, e, { resumableUploads: !1 }),
            }),
      ...
      (___class_81.VERSION = _$package_82.version),
      ___temp_81),
    _$error_187 = {};
  Object.defineProperty(_$error_187, "__esModule", { value: !0 });
  ...
  var hasOwn = Object.prototype.hasOwnProperty,
    ...
    _$extend_36 = function e() {
      var t,
        ...
        c = !1;
      for (
        "boolean" == typeof a && ((c = a), (a = arguments[1] || {}), (l = 2)),
        ...
        if (null != (t = arguments[l]))
          for (r in t)
            (n = getProperty(a, r)),
              a !== (o = getProperty(t, r)) &&
                (c && o && (isPlainObject(o) || (i = isArray(o)))
                  ? (i
                      ? ((i = !1), (s = n && isArray(n) ? n : []))
                      : (s = n && isPlainObject(n) ? n : {}),
                    setProperty(a, { name: r, newValue: e(c, s, o) }))
                  : void 0 !== o && setProperty(a, { name: r, newValue: o }));
      return a;
    },
    _$base64_44 = { exports: {} };
  (function (global) {
  ...
  var _$request_183 = {};
  Object.defineProperty(_$request_183, "__esModule", { value: !0 }),
  ...
  var obj,
    _urlParse2 =
      (obj = _$urlParse_76) && obj.__esModule ? obj : { default: obj },
    _$isReactNative_181 = {};
  Object.defineProperty(_$isReactNative_181, "__esModule", { value: !0 }),
  ...
  var _$uriToBlob_186 = {};
  Object.defineProperty(_$uriToBlob_186, "__esModule", { value: !0 }),
  ...
  var _$isCordova_180 = {};
  Object.defineProperty(_$isCordova_180, "__esModule", { value: !0 }),
  ...
  Object.defineProperty(_$readAsByteArray_182, "__esModule", { value: !0 }),
  ...
  var _$source_184 = {};
  Object.defineProperty(_$source_184, "__esModule", { value: !0 });
  ...
  var _$storage_185 = {};
  Object.defineProperty(_$storage_185, "__esModule", { value: !0 });
  ...
  var LocalStorage = (function () {
    ...
    _$fingerprint_179 = {};
  Object.defineProperty(_$fingerprint_179, "__esModule", { value: !0 }),
    (_$fingerprint_179.default = function (e, t, r) {
      return (0, ___isCordova2_179.default)()
        ? r(new Error("Fingerprint cannot be computed for file input type"))
        : (0, ___isReactNative2_179.default)()
        ? r(
            null,
            (function (e, t) {
              var r = e.exif
  ...
  var _$upload_189 = {};
  Object.defineProperty(_$upload_189, "__esModule", { value: !0 });
              ...
              value: function () {
                ...
                t
                  ? this.options.endpoint || this.options.uploadUrl
                    ? (this.options.resume &&
                        null == this._storage &&
                        (this._storage = (0, _$storage_185.getStorage)()),
                      this._source
                        ? this._start(this._source)
                        : (this.options.fileReader || _$source_184.getSource)(
                            t,
                  ...
                  t.open("POST", this.options.endpoint, !0),
                    (t.onload = function () {
                      if (inStatusCategory(t.status, 200)) {
                        ...
                        if (null != r) {
                          if (
                            ((e.url = (0, _$request_183.resolveUrl)(
                              e.options.endpoint,
                              r
                            )),
                            0 === e._size)
              ...
              value: function () {
                ...
                if (!this._aborted) {
                  ...
                  this.options.overridePatchMethod
                    ...
                    (t.onload = function () {
                      if (inStatusCategory(t.status, 200)) {
                        ...
                        if (isNaN(r))
                          ...
                          if (
                            (e._emitProgress(r, e._size),
                            e._emitChunkComplete(r - e._offset, r, e._size),
                            (e._offset = r),
                            r == e._size)
                          )
                            return (
                              e.options.removeFingerprintOnSuccess &&
                                e.options.resume &&
                                e._storage.removeItem(
                                  e._fingerprint,
                                  function (t) {
                                    t && e._emitError(t);
                                  }
                    ...
                    (t.onerror = function (r) {
                      e._aborted ||
                        e._emitXhrError(
                          t,
                          new Error(
                            "tus: failed to upload chunk at offset " + e._offset
                          ),
                          r
                        );
                    }),
                    "upload" in t &&
                      (t.upload.onprogress = function (t) {
                        t.lengthComputable &&
                          e._emitProgress(r + t.loaded, e._size);
                      }),
                    this._setupXHR(t),
                  ...
                  (n === 1 / 0 || n > this._size) &&
                    !this.options.uploadLengthDeferred &&
                    (n = this._size),
                    this._source.slice(r, n, function (r, n, o) {
                      r
                        ? e._emitError(r)
                        : (e.options.uploadLengthDeferred &&
                            o &&
                            ((e._size = e._offset + (n && n.size ? n.size : 0)),
                            t.setRequestHeader("Upload-Length", e._size)),
                          null === n
                            ? t.send()
                            : (t.send(n), e._emitProgress(e._offset, e._size)));
                    });
                }
              },
            },
  ...
  (Upload.defaultOptions = __defaultOptions_189),
    (_$upload_189.default = Upload);
  var __obj_188,
    _upload2 =
      (__obj_188 = _$upload_189) && __obj_188.__esModule
        ? __obj_188
        : { default: __obj_188 },
    storage = (function (e) {
  ...
  if ("undefined" != typeof window) {
    ...
    moduleExport.isSupported =
      __XMLHttpRequest_188 &&
      __Blob_188 &&
      "function" == typeof __Blob_188.prototype.slice;
      ...
      return function (t, r, n) {
        return ("undefined" != typeof window &&
          ...
          ("undefined" != typeof navigator &&
            "string" == typeof navigator.product &&
            "reactnative" === navigator.product.toLowerCase())
          ? _$moduleExport_188.Upload.defaultOptions.fingerprint(t, r, n)
          : n(null, ["tus", e.id, r.endpoint].join("-"));
      };
    },
    _$package_190 = { version: "1.5.0" },
    ___class_178,
    ___temp_178;
  ...
  var __Plugin_178 = _$lib_93.Plugin,
    ...
    _$lib_178 =
      ((___temp_178 = ___class_178 = (function (e) {
        var t, r;
        function n(t, r) {
          var n;
          return (
            ...
            (n.uploaderEvents = Object.create(null)),
            (n.uploaderSockets = Object.create(null)),
            (n.handleResetProgress = n.handleResetProgress.bind(
              ___assertThisInitialized_178(n)
            )),
            (n.handleUpload = n.handleUpload.bind(
              ___assertThisInitialized_178(n)
            )),
        ...
        return (
          ...
          (o.upload = function (e, t, r) {
            ...
            return (
              ...
              new Promise(function (t, r) {
                n.uppy.emit("upload-started", e);
                var o = ___extends_178(
                  {},
                  tusDefaultOptions,
                  n.opts,
                  e.tus || {}
                );
                (o.fingerprint = _$getFingerprint_177(e)),
                  ...
                  (o.onSuccess = function () {
                    ...
                    n.uppy.emit("upload-success", e, r),
                      a.url &&
                        n.uppy.log(
                          "Download " + a.file.name + " from " + a.url
                        ),
                      n.resetUploaderReferences(e.id),
                      l.done(),
                      t(a);
                ...
                n.onFileRemove(e.id, function (r) {
                  l.abort(),
                    n.resetUploaderReferences(e.id, { abort: !!a.url }),
            ...
            return (
              ...
              e.serverToken
                ...
                : new Promise(function (t, r) {
                    new (e.remote.providerOptions.provider
                      ? __Provider_178
                      : __RequestClient_178)(n.uppy, e.remote.providerOptions)
                      .post(
                        e.remote.url,
                        ___extends_178({}, e.remote.body, {
                          endpoint: o.endpoint,
                      ...
                      .then(function (t) {
                        return (
                          n.uppy.setFileState(e.id, { serverToken: t.token }),
                          (e = n.uppy.getFile(e.id)),
                          n.connectToServerSocket(e)
                        );
                      })
                      .then(function () {
                        t();
          ...
          (o.connectToServerSocket = function (e) {
            ...
            return new Promise(function (r, n) {
              var o = e.serverToken,
                i = _$getSocketHost_215(e.remote.companionUrl),
                s = new __Socket_178({ target: i + "/api/" + o, autoOpen: !1 });
              (t.uploaderSockets[e.id] = s),
                (t.uploaderEvents[e.id] = new _$EventTracker_195(t.uppy)),
                ...
                s.on("error", function (r) {
                  var o = r.error.message,
                    i = ___extends_178(new Error(o), { cause: r.error });
                  t.opts.useFastRemoteRetry
                    ? s.close()
                    : (t.resetUploaderReferences(e.id),
                      t.uppy.setFileState(e.id, { serverToken: null })),
                    t.uppy.emit("upload-error", e, i),
                    a.done(),
                    n(i);
                }),
                s.on("success", function (n) {
            ...
            r &&
              ((r.tus && r.tus.uploadUrl === t) ||
                ...
                this.uppy.setFileState(r.id, {
                  tus: ___extends_178({}, r.tus, { uploadUrl: t }),
                })));
          }),
          (o.onFileRemove = function (e, t) {
            this.uploaderEvents[e].on("file-removed", function (r) {
      ...
      (___class_178.VERSION = _$package_190.version),
      ___temp_178),
    ...
    function r() {
      if (r.enabled) {
        ...
        (i[0] = i[0].replace(/%([a-zA-Z%])/g, function (t, r) {
          ...
          _$debug_65.formatArgs.call(e, i),
          (r.log || _$debug_65.log || console.log.bind(console)).apply(e, i);
      }
    }
    return (
      (r.namespace = e),
      (r.enabled = _$debug_65.enabled(e)),
      (r.useColors = _$debug_65.useColors()),
      (r.color = (function (e) {
        var t,
          r = 0;
      ...
      (r.destroy = destroy),
      "function" == typeof _$debug_65.init && _$debug_65.init(r),
      _$debug_65.instances.push(r),
      r
    );
  }
  function destroy() {
  ...
  (_$debug_65 = _$debug_65 = createDebug.debug = createDebug.default = createDebug),
    (_$debug_65.coerce = function (e) {
    ...
    (_$debug_65.enable = function (e) {
      ...
      for (t = 0; t < n; t++)
        r[t] &&
          ("-" === (e = r[t].replace(/\*/g, ".*?"))[0]
            ? _$debug_65.skips.push(new RegExp("^" + e.substr(1) + "$"))
            : _$debug_65.names.push(new RegExp("^" + e + "$")));
    ...
    (_$debug_65.humanize = _$ms_66),
    (_$debug_65.instances = []),
    (_$debug_65.names = []),
    (_$debug_65.skips = []),
    (_$debug_65.formatters = {});
  var _$browser_64 = {};
  (function (t) {
    function r() {
      var r;
    ...
    ((_$browser_64 = _$browser_64 = _$debug_65).log = function () {
      ...
      (_$browser_64.formatArgs = function (e) {
        ...
        if (
          ((e[0] =
            ...
            (t ? "%c " : " ") +
            "+" +
            _$browser_64.humanize(this.diff)),
          t)
        ) {
      ...
      (_$browser_64.save = function (t) {
        try {
          null == t
            ? _$browser_64.storage.removeItem("debug")
            : (_$browser_64.storage.debug = t);
        } catch (e) {}
      }),
      (_$browser_64.load = r),
      (_$browser_64.useColors = function () {
        return (
          !(
            "undefined" == typeof window ||
            !window.process ||
      ...
      (_$browser_64.formatters.j = function (e) {
        try {
  ...
  var _$ms_74 = function (e, t) {
      ...
      if ("number" === n && !1 === isNaN(e))
        return t.long
          ? __plural_74((r = e), __d_74, "day") ||
              __plural_74(r, __h_74, "hour") ||
              __plural_74(r, __m_74, "minute") ||
              __plural_74(r, __s_74, "second") ||
              r + " ms"
          : (function (e) {
              return e >= __d_74
                ? Math.round(e / __d_74) + "d"
                : e >= __h_74
                ? Math.round(e / __h_74) + "h"
                : e >= __m_74
                ? Math.round(e / __m_74) + "m"
                : e >= __s_74
                ? Math.round(e / __s_74) + "s"
                : e + "ms";
            })(e);
      throw new Error(
        "val is not a non-empty string or a valid number. val=" +
    ...
    function r() {
      if (r.enabled) {
        ...
        (i[0] = i[0].replace(/%([a-zA-Z%])/g, function (t, r) {
          ...
          _$debug_72.formatArgs.call(e, i),
          (r.log || _$debug_72.log || console.log.bind(console)).apply(e, i);
      }
    }
    return (
      (r.namespace = e),
      (r.enabled = _$debug_72.enabled(e)),
      (r.useColors = _$debug_72.useColors()),
      (r.color = (function (e) {
        var t,
          r = 0;
        for (t in e) (r = (r << 5) - r + e.charCodeAt(t)), (r |= 0);
      ...
      (r.destroy = __destroy_72),
      "function" == typeof _$debug_72.init && _$debug_72.init(r),
      _$debug_72.instances.push(r),
      r
    );
  }
  ...
  (_$debug_72 = _$debug_72 = __createDebug_72.debug = __createDebug_72.default = __createDebug_72),
    (_$debug_72.coerce = function (e) {
      return e instanceof Error ? e.stack || e.message : e;
    }),
    ...
    (_$debug_72.enable = function (e) {
      ...
      for (t = 0; t < n; t++)
        r[t] &&
          ("-" === (e = r[t].replace(/\*/g, ".*?"))[0]
            ? _$debug_72.skips.push(new RegExp("^" + e.substr(1) + "$"))
            : _$debug_72.names.push(new RegExp("^" + e + "$")));
    ...
    (_$debug_72.humanize = _$ms_74),
    (_$debug_72.instances = []),
    (_$debug_72.names = []),
    (_$debug_72.skips = []),
    (_$debug_72.formatters = {});
  var _$browser_71 = {};
  (function (t) {
    function r() {
      var r;
    ...
    ((_$browser_71 = _$browser_71 = _$debug_72).log = function () {
      ...
      (_$browser_71.formatArgs = function (e) {
        ...
        if (
          ((e[0] =
            ...
            (t ? "%c " : " ") +
            "+" +
            _$browser_71.humanize(this.diff)),
          t)
        ) {
          var r = "color: " + this.color;
          e.splice(1, 0, r, "color: inherit");
      ...
      (_$browser_71.save = function (t) {
        try {
          null == t
            ? _$browser_71.storage.removeItem("debug")
            : (_$browser_71.storage.debug = t);
        } catch (e) {}
      }),
      (_$browser_71.load = r),
      (_$browser_71.useColors = function () {
        return (
          !(
            "undefined" == typeof window ||
            !window.process ||
      ...
      (_$browser_71.formatters.j = function (e) {
        try {
          return JSON.stringify(e);
        } catch (err) {
          return "[UnexpectedJSONParseError]: " + err.message;
  ...
  var _$componentEmitter_70 = { exports: {} };
  function Emitter(e) {
    if (e)
      return (function (e) {
  ...
  (_$componentEmitter_70.exports = Emitter),
      ...
      _$base64Js_5 = {
        toByteArray: function (e) {
          for (
            ...
            (t =
              (revLookup[e.charCodeAt(l)] << 18) |
              (revLookup[e.charCodeAt(l + 1)] << 12) |
              (revLookup[e.charCodeAt(l + 2)] << 6) |
              revLookup[e.charCodeAt(l + 3)]),
              (i[s++] = (t >> 16) & 255),
              (i[s++] = (t >> 8) & 255),
              (i[s++] = 255 & t);
          return (
            2 === o &&
              ((t =
                (revLookup[e.charCodeAt(l)] << 2) |
                (revLookup[e.charCodeAt(l + 1)] >> 4)),
              (i[s++] = 255 & t)),
            1 === o &&
              ((t =
                (revLookup[e.charCodeAt(l)] << 10) |
                (revLookup[e.charCodeAt(l + 1)] << 4) |
                (revLookup[e.charCodeAt(l + 2)] >> 2)),
              (i[s++] = (t >> 8) & 255),
              (i[s++] = 255 & t)),
            i
          );
        ...
        fromByteArray: function (e) {
          for (
            ...
            o.push(encodeChunk(e, i, i + 16383 > s ? s : i + 16383));
          return (
            1 === n
              ? ((t = e[r - 1]),
          ...
          t = Math.abs(t),
            isNaN(t) || t === 1 / 0
              ...
              : ((s = Math.floor(Math.log(t) / Math.LN2)),
                ...
                (t += s + p >= 1 ? d / l : d * Math.pow(2, 1 - p)) * l >= 2 &&
                  (s++, (l /= 2)),
                s + p >= c
                  ? ((a = 0), (s = c))
                  : s + p >= 1
                  ? ((a = (t * l - 1) * Math.pow(2, o)), (s += p))
                  : ((a = t * Math.pow(2, p - 1) * Math.pow(2, o)), (s = 0)));
          o >= 8;
          e[r + _] = 255 & a, _ += h, a /= 256, o -= 8
        );
        for (
          s = (s << o) | a, u += o;
          u > 0;
          e[r + _] = 255 & s, _ += h, s /= 256, u -= 8
        );
        e[r + _ - h] |= 128 * f;
      },
    },
  ...
  var _$binary_67 = {},
    ...
    withNativeBlob =
      ...
      ("undefined" != typeof Blob &&
        "[object BlobConstructor]" === __toString_67.call(Blob)),
    withNativeFile =
      "function" == typeof File ||
      ("undefined" != typeof File &&
        "[object FileConstructor]" === __toString_67.call(File));
  (_$binary_67.deconstructPacket = function (e) {
    ...
    (_$binary_67.removeBlobs = function (e, t) {
      ...
      !(function e(o, i, s) {
        if (!o) return o;
        if (
          (withNativeBlob && o instanceof Blob) ||
          (withNativeFile && o instanceof File)
        ) {
          r++;
  ...
  function Encoder() {}
  (_$socketIoParser_68.protocol = 4),
    (_$socketIoParser_68.types = [
      "CONNECT",
      "DISCONNECT",
      "EVENT",
      "ACK",
    ...
    (_$socketIoParser_68.CONNECT = 0),
    (_$socketIoParser_68.DISCONNECT = 1),
    (_$socketIoParser_68.EVENT = 2),
    (_$socketIoParser_68.ACK = 3),
    (_$socketIoParser_68.ERROR = 4),
    (_$socketIoParser_68.BINARY_EVENT = 5),
    (_$socketIoParser_68.BINARY_ACK = 6),
    (_$socketIoParser_68.Encoder = Encoder),
    (_$socketIoParser_68.Decoder = Decoder);
  var ERROR_PACKET = _$socketIoParser_68.ERROR + '"encode error"';
  function encodeAsString(t) {
    var r = "" + t.type;
    if (
      ((_$socketIoParser_68.BINARY_EVENT !== t.type &&
        _$socketIoParser_68.BINARY_ACK !== t.type) ||
        (r += t.attachments + "-"),
      t.nsp && "/" !== t.nsp && (r += t.nsp + ","),
      null != t.id && (r += t.id),
      null != t.data)
  ...
  function error(e) {
    return { type: _$socketIoParser_68.ERROR, data: "parser error: " + e };
  }
  (Encoder.prototype.encode = function (e, t) {
    __debug_68("encoding packet %j", e),
      _$socketIoParser_68.BINARY_EVENT === e.type ||
      _$socketIoParser_68.BINARY_ACK === e.type
        ? (function (e, t) {
    ...
    _$componentEmitter_70(Decoder.prototype),
    (Decoder.prototype.add = function (t) {
      ...
      if ("string" == typeof t)
        (r = (function (t) {
          ...
          if (null == _$socketIoParser_68.types[n.type])
            return error("unknown packet type " + n.type);
          if (
            _$socketIoParser_68.BINARY_EVENT === n.type ||
            _$socketIoParser_68.BINARY_ACK === n.type
          ) {
            for (
              var o = "";
          ...
          if (t.charAt(++r)) {
            ...
            if (
              !(
                !1 !== a &&
                (n.type === _$socketIoParser_68.ERROR || _$isarray_73(a))
              )
            )
          ...
          _$socketIoParser_68.BINARY_EVENT === r.type ||
          _$socketIoParser_68.BINARY_ACK === r.type
            ? ((this.reconstructor = new BinaryReconstructor(r)),
              0 === this.reconstructor.reconPack.attachments &&
                this.emit("decoded", r))
            : this.emit("decoded", r);
      else {
        if (!_$isBuffer_69(t) && !t.base64)
  ...
  (_$componentEmitter_26.exports = __Emitter_26),
    (__Emitter_26.prototype.on = __Emitter_26.prototype.addEventListener = function (
      e,
      t
    ) {
      return (
    ...
    (__Emitter_26.prototype.off = __Emitter_26.prototype.removeListener = __Emitter_26.prototype.removeAllListeners = __Emitter_26.prototype.removeEventListener = function (
      e,
      t
    ) {
      if (((this._callbacks = this._callbacks || {}), 0 == arguments.length))
    ...
    function r() {
      if (r.enabled) {
        ...
        (i[0] = i[0].replace(/%([a-zA-Z%])/g, function (t, r) {
          ...
          _$debug_28.formatArgs.call(e, i),
          (r.log || _$debug_28.log || console.log.bind(console)).apply(e, i);
      }
    }
    return (
      (r.namespace = e),
  ...
  (function (e) {
    ...
    _$hasBinary_38 = function t(o) {
      ...
      if (
        ("function" == typeof e && e.isBuffer && e.isBuffer(o)) ||
        ("function" == typeof ArrayBuffer && o instanceof ArrayBuffer) ||
        (r && o instanceof Blob) ||
        (n && o instanceof File)
      )
        return !0;
      if (o.toJSON && "function" == typeof o.toJSON && 1 === arguments.length)
        return t(o.toJSON(), !0);
      for (var a in o)
  ...
  var _$after_1 = function (e, t, r) {
      ...
      function o(e, i) {
        ...
        --o.count,
          e ? ((n = !0), t(e), (t = r)) : 0 !== o.count || n || t(null, i);
      }
    },
    byteArray,
    byteCount,
      ...
      decode: function (e, t) {
        ...
        return (function (e) {
          for (var t, r = e.length, n = -1, o = ""; ++n < r; )
            (t = e[n]) > 65535 &&
              ((o += stringFromCharCode(
                (((t -= 65536) >>> 10) & 1023) | 55296
              )),
              (t = 56320 | (1023 & t))),
              (o += stringFromCharCode(t));
          return o;
        })(o);
      },
    },
  ...
  !(function () {
    ...
    (_$base64Arraybuffer_4.encode = function (t) {
      ...
      (_$base64Arraybuffer_4.decode = function (e) {
        ...
        for (r = 0; r < l; r += 4)
          (n = t[e.charCodeAt(r)]),
            (o = t[e.charCodeAt(r + 1)]),
            (i = t[e.charCodeAt(r + 2)]),
  ...
  (_$browser_30.encodePacket = function (e, t, r, n) {
    ...
    if (void 0 !== _$blob_6 && o instanceof _$blob_6)
      return (function (e, t, r) {
        if (!t) return _$browser_30.encodeBase64Packet(e, r);
        if (dontSendBlobs)
          return (function (e, t, r) {
    ...
    (_$browser_30.encodeBase64Packet = function (t, r) {
      var n,
        o = "b" + _$browser_30.packets[t.type];
      ...
      try {
        ...
        for (
          var s = new Uint8Array(t.data), a = new Array(s.length), l = 0;
          l < s.length;
          l++
        )
          a[l] = s[l];
    ...
    (_$browser_30.decodePacket = function (t, r, n) {
      ...
      if ("string" == typeof t) {
        ...
        if (
          ...
          return err;
        var o = t.charAt(0);
        return Number(o) == o && packetslist[o]
          ? t.length > 1
            ? { type: packetslist[o], data: t.substring(1) }
            : { type: packetslist[o] }
          : err;
      }
      ...
      return (
        _$blob_6 && "blob" === r && (i = new _$blob_6([i])),
        { type: packetslist[o], data: i }
      );
    }),
    ...
    (_$browser_30.decodePayload = function (e, t, r) {
      ...
      for (var o, i, s = "", a = 0, l = e.length; a < l; a++) {
        ...
        if (":" === u) {
          ...
          if (i.length) {
            if (
              ((n = _$browser_30.decodePacket(i, t, !1)),
          ...
          return (
            r.forEach(function (e) {
              var t = "string" == typeof e,
                r = e;
              if (t) {
                for (var n = new Uint8Array(e.length), s = 0; s < e.length; s++)
                  n[s] = e.charCodeAt(s);
                r = n.buffer;
              }
              o[i++] = t ? 0 : 1;
              ...
              for (
                o[i++] = 255, n = new Uint8Array(r), s = 0;
                s < n.length;
                s++
              )
                o[i++] = n[s];
    ...
    (_$browser_30.decodePayloadAsBinary = function (t, r, n) {
      ...
      for (var o = t, i = []; o.byteLength > 0; ) {
        for (
          var s = new Uint8Array(o), a = 0 === s[0], l = "", u = 1;
          255 !== s[u];
          u++
        ) {
        ...
        if (a)
          try {
            ...
            for (c = "", u = 0; u < p.length; u++)
              c += String.fromCharCode(p[u]);
          }
  ...
  var _$xmlhttprequest_25 = function (t) {
      var r = t.xdomain,
        ...
        o = t.enablesXDR;
      try {
        if ("undefined" != typeof XMLHttpRequest && (!r || _$hasCors_40))
  ...
  (yeast.encode = encode),
    (yeast.decode = function (e) {
      var t = 0;
      for (__i_79 = 0; __i_79 < e.length; __i_79++)
        t = t * length + __map_79[e.charAt(__i_79)];
      return t;
    }),
    (_$yeast_79 = yeast);
    ...
    (Polling.prototype.uri = function () {
      ...
      return (
        !1 !== this.timestampRequests &&
          (e[this.timestampParam] = _$yeast_79()),
        this.supportsBinary || e.sid || (e.b64 = 1),
        (e = _$parseqs_50.encode(e)),
        this.port &&
  ...
  if (
    ...
    (Request.prototype.onLoad = function () {
      ...
      try {
        ...
        t =
          ("application/octet-stream" === r && this.xhr.response) ||
  ...
  (function (t) {
    var r,
      n,
      o = _$browser_27("engine.io-client:websocket");
    ...
    function s(e) {
      e && e.forceBase64 && (this.supportsBinary = !1),
        ...
        this.usingBrowserWebSocket || (i = n),
    ...
    (_$websocket_24 = s),
      ...
      (s.prototype.write = function (r) {
        var n = this;
        this.writable = !1;
        for (var i = r.length, s = 0, a = i; s < a; s++)
          !(function (r) {
            _$browser_30.encodePacket(r, n.supportsBinary, function (s) {
              if (!n.usingBrowserWebSocket) {
                ...
                r.options && (a.compress = r.options.compress),
                  n.perMessageDeflate &&
                    ("string" == typeof s ? t.byteLength(s) : s.length) <
      ...
      (s.prototype.uri = function () {
        ...
        return (
          this.port &&
            ...
            (r = ":" + this.port),
          this.timestampRequests && (e[this.timestampParam] = _$yeast_79()),
          this.supportsBinary || (e.b64 = 1),
          (e = _$parseqs_50.encode(e)).length && (e = "?" + e),
          t +
            "://" +
            (-1 !== this.hostname.indexOf(":")
              ? "[" + this.hostname + "]"
  ...
  function __Socket_18(e, t) {
    ...
    (t = t || {}),
      ...
      e
        ...
        : t.host && (t.hostname = _$parseuri_51(t.host).host),
      (this.secure =
        null != t.secure
          ? t.secure
      ...
      "string" == typeof this.query &&
        (this.query = _$parseqs_50.decode(this.query)),
  ...
  (_$socket_18 = __Socket_18),
    ...
    (__Socket_18.prototype.probe = function (e) {
          ...
          t.once("packet", function (o) {
            if (!r)
              if ("pong" === o.type && "probe" === o.data) {
                if (
                  (__debug_18('probe transport "%s" pong', e),
                  (n.upgrading = !0),
                  n.emit("upgrading", t),
                  !t)
                )
      ...
      function s(r) {
        ...
        (o.transport = t.name),
          i(),
          __debug_18('probe transport "%s" failed because of error: %s', e, r),
      ...
      function u(e) {
        t &&
          e.name !== t.name &&
          (__debug_18('"%s" works - aborting "%s"', e.name, t.name), i());
      }
      function c() {
    ...
    (__Socket_18.prototype.write = __Socket_18.prototype.send = function (
      e,
      t,
      r
    ) {
  ...
  var _$componentEmitter_63 = { exports: {} };
  ...
  (_$componentEmitter_63.exports = __Emitter_63),
    (__Emitter_63.prototype.on = __Emitter_63.prototype.addEventListener = function (
      e,
      t
    ) {
      return (
    ...
    (__Emitter_63.prototype.off = __Emitter_63.prototype.removeListener = __Emitter_63.prototype.removeAllListeners = __Emitter_63.prototype.removeEventListener = function (
      e,
      t
    ) {
      if (((this._callbacks = this._callbacks || {}), 0 == arguments.length))
  ...
  _$componentEmitter_63(__Socket_61.prototype),
    (__Socket_61.prototype.subEvents = function () {
      if (!this.subs) {
        var e = this.io;
        this.subs = [
          _$on_60(e, "open", _$componentBind_10(this, "onopen")),
          _$on_60(e, "packet", _$componentBind_10(this, "onpacket")),
          _$on_60(e, "close", _$componentBind_10(this, "onclose")),
        ];
      }
    }),
      ...
      var t = _$toArray_75(arguments),
        r = {
          type: (
            ...
            ? _$socketIoParser_68.BINARY_EVENT
            : _$socketIoParser_68.EVENT,
          data: t,
          options: {},
        };
      return (
        ...
        "function" == typeof t[t.length - 1] &&
          (__debug_61("emitting packet with ack id %d", this.ids),
        ...
        if (this.query) {
          var e =
            "object" == typeof this.query
              ? _$parseqs_50.encode(this.query)
              : this.query;
          __debug_61("sending connect packet with query %s", e),
            this.packet({ type: _$socketIoParser_68.CONNECT, query: e });
        } else this.packet({ type: _$socketIoParser_68.CONNECT });
    }),
    (__Socket_61.prototype.onclose = function (e) {
      __debug_61("close (%s)", e),
        (this.connected = !1),
        (this.disconnected = !0),
        delete this.id,
    ...
    (__Socket_61.prototype.onevent = function (e) {
      var t = e.data || [];
      __debug_61("emitting event %j", t),
        null != e.id &&
          (__debug_61("attaching ack callback to event"),
    ...
    (__Socket_61.prototype.ack = function (e) {
      ...
      return function () {
        if (!r) {
          ...
          __debug_61("sending ack %j", n),
            t.packet({
              type: _$hasBinary_38(n)
                ? _$socketIoParser_68.BINARY_ACK
                : _$socketIoParser_68.ACK,
              id: e,
              data: n,
            });
        }
    ...
    (__Socket_61.prototype.onack = function (e) {
      ...
      "function" == typeof t
        ? (__debug_61("calling ack %s with %j", e.id, e.data),
          t.apply(this, e.data),
          delete this.acks[e.id])
        : __debug_61("bad ack %s", e.id);
    }),
    ...
    (__Socket_61.prototype.ondisconnect = function () {
      __debug_61("server disconnect (%s)", this.nsp),
        this.destroy(),
    ...
    (__Socket_61.prototype.close = __Socket_61.prototype.disconnect = function () {
      return (
        this.connected &&
          (__debug_61("performing disconnect (%s)", this.nsp),
          this.packet({ type: _$socketIoParser_68.DISCONNECT })),
        this.destroy(),
  ...
  (_$manager_59 = Manager),
    ...
    (Manager.prototype.open = Manager.prototype.connect = function (e, t) {
      if (
        (__debug_59("readyState %s", this.readyState),
        ~this.readyState.indexOf("open"))
      )
        return this;
      __debug_59("opening %s", this.uri),
      ...
      if (!1 !== this._timeout) {
        ...
        var a = setTimeout(function () {
          __debug_59("connect attempt timed out after %d", s),
            o.destroy(),
            r.close(),
    ...
    (Manager.prototype.onopen = function () {
      __debug_59("open"),
        ...
        this.emit("open");
      var e = this.engine;
      this.subs.push(_$on_60(e, "data", _$componentBind_10(this, "ondata"))),
        this.subs.push(_$on_60(e, "ping", _$componentBind_10(this, "onping"))),
        this.subs.push(_$on_60(e, "pong", _$componentBind_10(this, "onpong"))),
        this.subs.push(
          _$on_60(e, "error", _$componentBind_10(this, "onerror"))
        ),
        this.subs.push(
          _$on_60(e, "close", _$componentBind_10(this, "onclose"))
        ),
    ...
    (Manager.prototype.reconnect = function () {
      ...
      if (this.backoff.attempts >= this._reconnectionAttempts)
        __debug_59("reconnect failed"),
          this.backoff.reset(),
          this.emitAll("reconnect_failed"),
          (this.reconnecting = !1);
      else {
        var t = this.backoff.duration();
        __debug_59("will wait %dms before reconnect attempt", t),
          (this.reconnecting = !0);
        var r = setTimeout(function () {
          e.skipReconnect ||
            (__debug_59("attempting reconnect"),
            e.emitAll("reconnect_attempt", e.backoff.attempts),
            e.emitAll("reconnecting", e.backoff.attempts),
            e.skipReconnect ||
              e.open(function (t) {
                t
                  ? (__debug_59("reconnect attempt error"),
                    (e.reconnecting = !1),
                    e.reconnect(),
                    e.emitAll("reconnect_error", t.data))
                  : (__debug_59("reconnect success"), e.onreconnect());
              }));
        }, t);
        this.subs.push({
          destroy: function () {
  ...
  (_$componentEmitter_11.exports = __Emitter_11),
    (__Emitter_11.prototype.on = __Emitter_11.prototype.addEventListener = function (
      e,
      t
    ) {
      return (
    ...
    (__Emitter_11.prototype.off = __Emitter_11.prototype.removeListener = __Emitter_11.prototype.removeAllListeners = __Emitter_11.prototype.removeEventListener = function (
      e,
      t
    ) {
      if (((this._callbacks = this._callbacks || {}), 0 == arguments.length))
  ...
  var TransloaditAssembly = (function (e) {
      ...
      return (
        ...
        (o._connectSocket = function () {
          ...
          r.on("connect", function () {
            r.emit("assembly_connect", { id: e.status.assembly_id }),
              e.emit("connect");
          }),
            r.on("error", function () {
            ...
            r.on("assembly_result_finished", function (t, r) {
              e.emit("result", t, r),
                e.status.results[t] || (e.status.results[t] = []),
                e.status.results[t].push(r);
            }),
        ...
        (o._diffStatus = function (e, t) {
          ...
          var i =
            isStatus(o, "ASSEMBLY_EXECUTING") &&
            !isStatus(n, "ASSEMBLY_EXECUTING");
          i && this.emit("executing"),
            ...
            isStatus(o, "ASSEMBLY_COMPLETED") &&
              !isStatus(n, "ASSEMBLY_COMPLETED") &&
              this.emit("finished");
        }),
        (o.close = function () {
          (this.closed = !0),
      ...
      return (
        (t.createAssembly = function (e) {
          ...
          s.append("params", "string" == typeof r ? r : JSON.stringify(r)),
            o && s.append("signature", o),
            Object.keys(n).forEach(function (e) {
              s.append(e, n[e]);
            }),
            s.append("num_expected_upload_files", i);
          var a = this.opts.service + "/assemblies";
          return fetch(a, { method: "post", headers: this._headers, body: s })
            .then(function (e) {
              return e.json();
            })
            .then(function (e) {
        ...
        (t.reserveFile = function (e, t) {
          ...
          return fetch(o, { method: "post", headers: this._headers })
            .then(function (e) {
              return e.json();
            })
            .catch(function (n) {
        ...
        (t.addFile = function (e, t) {
          ...
          return fetch(s, { method: "post", headers: this._headers })
            .then(function (e) {
              return e.json();
            })
            .catch(function (n) {
        ...
        (t.cancelAssembly = function (e) {
          ...
          return fetch(r, { method: "delete", headers: this._headers })
            .then(function (e) {
              return e.json();
            })
            .catch(function (e) {
        ...
        (t.getAssemblyStatus = function (e) {
          var t = this;
          return fetch(e, { headers: this._headers })
            .then(function (e) {
              return e.json();
            })
            .catch(function (r) {
        ...
        return (
          e.forEach(function (e) {
            var r,
              ...
              i = JSON.stringify(o);
            t[i]
              ? (r = t[i].fileIDs).push.apply(r, n)
              : (t[i] = { options: o, fileIDs: [].concat(n) });
          }),
  ...
  (_$AssemblyOptions_171 = AssemblyOptions),
    (_$AssemblyOptions_171.validateParams = validateParams);
  var TransloaditAssemblyWatcher = (function (e) {
      ...
      function n(t, r) {
        ...
        return (
          ...
          (n._onAssemblyComplete = n._onAssemblyComplete.bind(
            ___assertThisInitialized_172(n)
          )),
          (n._onAssemblyCancel = n._onAssemblyCancel.bind(
            ___assertThisInitialized_172(n)
          )),
          (n._onAssemblyError = n._onAssemblyError.bind(
            ___assertThisInitialized_172(n)
          )),
          (n._onImportError = n._onImportError.bind(
            ___assertThisInitialized_172(n)
          )),
          n._addListeners(),
          n
  ...
  (___temp_174 = ___class_174 = (function (e) {
    ...
    function n(t, r) {
      ...
      (n.opts = ___extends_174({}, o, {}, r)),
        n.i18nInit(),
        (n._prepareUpload = n._prepareUpload.bind(
          ___assertThisInitialized_174(n)
        )),
        (n._afterUpload = n._afterUpload.bind(___assertThisInitialized_174(n))),
        (n._onError = n._onError.bind(___assertThisInitialized_174(n))),
        (n._onTusError = n._onTusError.bind(___assertThisInitialized_174(n))),
        (n._onCancelAll = n._onCancelAll.bind(___assertThisInitialized_174(n))),
        (n._onFileUploadURLAvailable = n._onFileUploadURLAvailable.bind(
          ___assertThisInitialized_174(n)
        )),
        (n._onRestored = n._onRestored.bind(___assertThisInitialized_174(n))),
        (n._getPersistentData = n._getPersistentData.bind(
          ___assertThisInitialized_174(n)
        ));
      var i = n.opts.getAssemblyOptions !== o.getAssemblyOptions;
      return (
        n.opts.params
          ? _$AssemblyOptions_171.validateParams(n.opts.params)
          : i || _$AssemblyOptions_171.validateParams(null),
        (n.client = new _$Client_173({
    ...
    return (
      ...
      (o._getClientVersion = function () {
        ...
        return (
          this.opts.importFromUploadURLs &&
            (r("XHRUpload", "uppy-xhr-upload"),
            r("AwsS3", "uppy-aws-s3"),
            r("AwsS3Multipart", "uppy-aws-s3-multipart")),
      ...
      (o._attachAssemblyMetadata = function (e, t) {
        var r = ___extends_174({}, e.meta, {
          ...
          n = ___extends_174({}, e.tus, { endpoint: t.tus_url }),
          o = e.remote;
        ...
        return (
          this.opts.importFromUploadURLs ||
            ___extends_174(l, { meta: r, tus: n, remote: o }),
          l
        );
      }),
        ...
        return (
          ...
          this.client
            ...
            .then(function (r) {
              var o,
                i,
                s = new _$TransloaditAssembly_170(r),
                a = s.status,
                l = n.getPluginState(),
                u = l.assemblies,
                c = l.uploadsAssemblies;
              n.setPluginState({
                assemblies: ___extends_174(
                  {},
                  u,
                  ((o = {}), (o[a.assembly_id] = a), o)
                ),
                uploadsAssemblies: ___extends_174(
                  {},
                  c,
                  ((i = {}), (i[t] = [].concat(c[t], [a.assembly_id])), i)
                ),
              });
              ...
              return (
                ...
                n.uppy.setState({ files: ___extends_174({}, p, {}, d) }),
                n.uppy.emit("transloadit:assembly-created", a, e),
                n._connectAssembly(s),
                n.uppy.log("[Transloadit] Created Assembly " + a.assembly_id),
                s
              );
            })
            .catch(function (e) {
              throw (
                ((e.message =
                  n.i18n("creatingAssemblyFailed") + ": " + e.message),
                e)
              );
            })
        );
      ...
      (o._onFileUploadComplete = function (e, t) {
        ...
        o
          ? (this.setPluginState({
              files: ___extends_174(
                {},
                n.files,
                ((r = {}),
                (r[t.id] = { assembly: e, id: o.id, uploadedFile: t }),
                r)
              ),
            }),
      ...
      (o._onResult = function (e, t, r) {
        ...
        this.setPluginState({ results: [].concat(n.results, [i]) }),
              ...
              Object.keys(e).forEach(function (n) {
                ...
                Object.keys(o.results).forEach(function (e) {
                  o.results[e].forEach(function (t) {
                    ...
                    (t.localId = r ? r.id : null),
                      i.push({ id: t.id, result: t, stepName: e, assembly: n });
                  });
                });
              }),
              t.setPluginState({
      ...
      (o._prepareUpload = function (e, t) {
              ...
              .catch(function (e) {
                throw (
                  (r.forEach(function (t) {
                    ...
                    n.uppy.emit("preprocess-complete", r),
        ...
        return new _$AssemblyOptions_171(s, this.opts).build().then(
          function (e) {
      ...
      (o._afterUpload = function (e, t) {
        ...
        if (!this._shouldWaitAfterUpload()) {
          ...
          return (
            this.uppy.addResultData(t, { transloadit: i }), Promise.resolve()
          );
        }
        if (0 === o.length)
          return (
        ...
        return (
          ...
          s.promise.then(function () {
            ...
            delete n[t],
              r.setPluginState({ uploadsAssemblies: n }),
              r.uppy.addResultData(t, { transloadit: e });
          })
        );
      }),
      (o._onError = function (e, t) {
        var r = this;
        this.uppy.log("[Transloadit] _onError in upload " + t),
          this.uppy.log(e),
      ...
      (o.install = function () {
        ...
        var e = this.uppy.getState().capabilities;
        this.uppy.setState({
          capabilities: ___extends_174({}, e, { individualCancellation: !1 }),
        });
      }),
      (o.uninstall = function () {
        ...
        var e = this.uppy.getState().capabilities;
        this.uppy.setState({
          capabilities: ___extends_174({}, e, { individualCancellation: !0 }),
        });
      }),
    ...
    (___class_174.VERSION = _$package_176.version),
    (_$lib_174 = ___temp_174),
    (_$lib_174.COMPANION = COMPANION),
    (_$lib_174.UPPY_SERVER = COMPANION),
    (_$lib_174.COMPANION_PATTERN = /\.transloadit\.com$/);
  var _$lib_37 = { __esModule: !0 };
  ...
  function getFormData(e) {
    ...
    for (
      var r = {}, n = void 0, o = [], i = {}, s = 0, a = e.elements.length;
      s < a;
      s++
    ) {
      var l = e.elements[s];
      IGNORED_ELEMENT_TYPES[l.type] ||
        l.disabled ||
        ((n = l.name || l.id) && !i[n] && (o.push(n), (i[n] = !0)));
    }
  ...
  function getFormElementValue(e, t) {
    ...
    if ("select-multiple" === n) {
      r = [];
      for (var o = 0, i = e.options.length; o < i; o++)
        e.options[o].selected && r.push(e.options[o].value);
  ...
  var _$package_129 = { version: "1.3.3" },
    ___class_128,
    ___temp_128;
  function ___extends_128() {
    return (___extends_128 =
      Object.assign ||
      function (e) {
        for (var t = 1; t < arguments.length; t++) {
          var r = arguments[t];
  ...
  var __Plugin_128 = _$lib_93.Plugin,
    ...
    _$lib_128 =
      ((___temp_128 = ___class_128 = (function (e) {
        var t, r;
        function n(t, r) {
          var n;
          return (
            ...
            (n.handleFormSubmit = n.handleFormSubmit.bind(
              ___assertThisInitialized_128(n)
            )),
            (n.handleUploadStart = n.handleUploadStart.bind(
              ___assertThisInitialized_128(n)
            )),
            (n.handleSuccess = n.handleSuccess.bind(
              ___assertThisInitialized_128(n)
            )),
            (n.addResultToForm = n.addResultToForm.bind(
              ___assertThisInitialized_128(n)
            )),
            (n.getMetaFromForm = n.getMetaFromForm.bind(
              ___assertThisInitialized_128(n)
            )),
            n
          );
        ...
        return (
          ...
          (o.install = function () {
            (this.form = _$findDOMElement_204(this.opts.target)),
      ...
      (___class_128.VERSION = _$package_129.version),
      ___temp_128),
  ...
  (ServiceWorkerStore.isSupported = isSupported),
    (_$ServiceWorkerStore_132 = ServiceWorkerStore);
  var _$IndexedDBStore_130 = {};
  function ___extends_130() {
    return (___extends_130 =
      Object.assign ||
      function (e) {
        for (var t = 1; t < arguments.length; t++) {
          var r = arguments[t];
    ...
    return new Promise(function (e, r) {
      (t.onupgradeneeded = function (t) {
        ...
        if (
          ...
          o.createIndex("expires", "expires", { unique: !1 }),
  ...
  var cleanedUp = !1,
    IndexedDBStore = (function () {
      function e(t) {
        ...
        cleanedUp
          ? (this.ready = n())
          : ((cleanedUp = !0), (this.ready = e.cleanup().then(n, n)));
      }
      var t = e.prototype;
      return (
        (t.key = function (e) {
            ...
            .then(function (t) {
              return waitForRequest(
                t
                  ...
                  .index("store")
                  .getAll(IDBKeyRange.only(e.name))
              );
            })
            .then(function (e) {
              var t = {};
        ...
        (t.getSize = function () {
          ...
          return this.ready.then(function (t) {
            var r = t
              ...
              .objectStore(STORE_NAME)
              .index("store")
              .openCursor(IDBKeyRange.only(e.name));
  ...
  (IndexedDBStore.isSupported = __isSupported_130),
    (_$IndexedDBStore_130 = IndexedDBStore);
  var __cleanedUp_131 = !1,
    _$MetaDataStore_131 = (function () {
      function e(t) {
        (this.opts = ___extends_131({ expires: 864e5 }, t)),
          (this.name = "uppyState:" + t.storeName),
          __cleanedUp_131 || ((__cleanedUp_131 = !0), e.cleanup());
      }
      var t = e.prototype;
      return (
        (t.load = function () {
    ...
    _$package_134 = { version: "1.3.2" },
    ___class_133,
    ___temp_133;
  function ___extends_133() {
    return (___extends_133 =
      Object.assign ||
      function (e) {
        for (var t = 1; t < arguments.length; t++) {
          var r = arguments[t];
  ...
  var __Plugin_133 = _$lib_93.Plugin,
    _$lib_133 =
      ((___temp_133 = ___class_133 = (function (e) {
        var t, r;
        function n(t, r) {
          var n;
          return (
            ...
            (n.opts = ___extends_133(
              {},
              { expires: 864e5, serviceWorker: !1 },
              r
            )),
            (n.MetaDataStore = new _$MetaDataStore_131({
              expires: n.opts.expires,
              storeName: t.getID(),
            })),
            (n.ServiceWorkerStore = null),
            n.opts.serviceWorker &&
              (n.ServiceWorkerStore = new _$ServiceWorkerStore_132({
                storeName: t.getID(),
              })),
            ...
            (n.saveFilesStateToLocalStorage = n.saveFilesStateToLocalStorage.bind(
              ___assertThisInitialized_133(n)
            )),
            (n.loadFilesStateFromLocalStorage = n.loadFilesStateFromLocalStorage.bind(
              ___assertThisInitialized_133(n)
            )),
            (n.loadFileBlobsFromServiceWorker = n.loadFileBlobsFromServiceWorker.bind(
              ___assertThisInitialized_133(n)
            )),
            (n.loadFileBlobsFromIndexedDB = n.loadFileBlobsFromIndexedDB.bind(
              ___assertThisInitialized_133(n)
            )),
            (n.onBlobsLoaded = n.onBlobsLoaded.bind(
              ___assertThisInitialized_133(n)
            )),
            n
          );
        ...
        var o = n.prototype;
        return (
          (o.loadFilesStateFromLocalStorage = function () {
              ...
              .then(function (t) {
                ...
                return r === e.uppy.getFiles().length
                  ? (e.uppy.log(
                    ...
                    e.uppy.info(
                      "Successfully recovered " + r + " files",
                      "success",
                      3e3
                    ),
                    e.onBlobsLoaded(t))
          ...
          (o.onBlobsLoaded = function (e) {
            ...
            Object.keys(e).forEach(function (o) {
              ...
              if (i) {
                var s = ___extends_133({}, i, { data: e[o], isRestored: !0 });
                n[o] = s;
              } else r.push(o);
            }),
              ...
              r.length &&
                this.deleteBlobs(r)
                  .then(function () {
                    t.uppy.log(
                      "[GoldenRetriever] Cleaned up " + r.length + " old files"
                    );
                  })
                  .catch(function (e) {
                    t.uppy.log(
      ...
      (___class_133.VERSION = _$package_134.version),
      ___temp_133),
    _$package_158 = { version: "1.3.1" },
    ___class_157,
    ___temp_157;
  function ___extends_157() {
    return (___extends_157 =
      Object.assign ||
      function (e) {
        for (var t = 1; t < arguments.length; t++) {
          var r = arguments[t];
  ...
  var __Plugin_157 = _$lib_93.Plugin,
    _$lib_157 =
      ((___temp_157 = ___class_157 = (function (e) {
        ...
        function n(t, r) {
          ...
          return (
            ...
            (n.opts = ___extends_157({}, {}, r)),
            (n.handleStateChange = n.handleStateChange.bind(
              ___assertThisInitialized_157(n)
            )),
            (n.initDevTools = n.initDevTools.bind(
              ___assertThisInitialized_157(n)
            )),
            n
          );
        ...
        var o = n.prototype;
        return (
          (o.handleStateChange = function (e, t, r) {
                ...
                if ("DISPATCH" === t.type)
                  switch ((console.log(t.payload.type), t.payload.type)) {
                    ...
                    case "IMPORT_STATE":
                      ...
                      return (
                        (e.uppy.store.state = ___extends_157(
                          {},
                          e.uppy.getState(),
                          r[r.length - 1].state
                        )),
                        void e.uppy.updateAll(e.uppy.getState())
                      );
                    case "JUMP_TO_STATE":
                    case "JUMP_TO_ACTION":
                      (e.uppy.store.state = ___extends_157(
      ...
      ___temp_157),
    _$uppy_241 = {};
  (_$uppy_241.Core = _$lib_93),
    (_$uppy_241.debugLogger = _$uppy_241.Core.debugLogger),
    (_$uppy_241.server = _$lib_89),
    (_$uppy_241.views = { ProviderView: _$lib_155 }),
    (_$uppy_241.DefaultStore = _$lib_163),
    (_$uppy_241.ReduxStore = _$lib_165),
    (_$uppy_241.Dashboard = _$lib_112),
    (_$uppy_241.DragDrop = _$lib_122),
    (_$uppy_241.FileInput = _$lib_126),
    (_$uppy_241.Informer = _$lib_138),
    (_$uppy_241.ProgressBar = _$lib_142),
    (_$uppy_241.StatusBar = _$lib_161),
    (_$uppy_241.Dropbox = _$lib_124),
    (_$uppy_241.GoogleDrive = _$lib_136),
    (_$uppy_241.Instagram = _$lib_140),
    (_$uppy_241.Url = _$lib_192),
    (_$uppy_241.Webcam = _$lib_235),
    (_$uppy_241.AwsS3 = _$lib_83),
    (_$uppy_241.AwsS3Multipart = _$lib_81),
    (_$uppy_241.Transloadit = _$lib_174),
    (_$uppy_241.Tus = _$lib_178),
    (_$uppy_241.XHRUpload = _$lib_238),
    (_$uppy_241.Form = _$lib_128),
    (_$uppy_241.GoldenRetriever = _$lib_133),
    (_$uppy_241.ReduxDevTools = _$lib_157),
    (_$uppy_241.ThumbnailGenerator = _$lib_168),
    (_$uppy_241.locales = {});
  var _$bundle_240 = {};
