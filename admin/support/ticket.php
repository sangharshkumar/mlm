        ...
        <div class="page-wrapper">
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="<?php echo $base_url; ?>/admin/support/">Support</a></li>
            ...
            <div class="container-fluid">
                ...
                <div class="col-12 card d-flex flex-row align-items-center py-3 px-4 justify-content-between">
                    ...
                    ?>
                        <button id="admin_close_ticket_btn" class="btn btn-danger">Close Ticket</button>
                    <?php
                    } else {
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form id="admin_add_reply_to_ticket" class="needs-validation" ticket-id="<?php echo $ticket_id; ?>" novalidate="">
                                        <div class="form-row">
